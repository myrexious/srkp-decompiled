...
public class PlainTextFormatter {
        ...
        for (PlainText.Paragraph paragraph : this.textContent.getParagraphs()) {
            if (this.wrapLines) {
                ...
                if (stringWidth < this.width) {
                    int i = AnonymousClass1.$SwitchMap$com$tom_roush$pdfbox$pdmodel$interactive$form$PlainTextFormatter$TextAlign[this.textAlignment.ordinal()];
                    if (i == 1) {
    ...
    /* renamed from: com.tom_roush.pdfbox.pdmodel.interactive.form.PlainTextFormatter$1 */
    /* loaded from: classes3.dex */
