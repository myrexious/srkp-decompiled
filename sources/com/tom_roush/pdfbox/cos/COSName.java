...
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    public static final COSName CS = new COSName(OperatorName.STROKING_COLORSPACE);
    ...
    public static final COSName DP = new COSName(OperatorName.MARKED_CONTENT_POINT_WITH_PROPS);
    ...
    public static final COSName FUNCTION = new COSName(FlashType.FUNCTION);
    ...
    public static final COSName G = new COSName(OperatorName.STROKING_COLOR_GRAY);
    ...
    public static final COSName ID = new COSName(OperatorName.BEGIN_INLINE_IMAGE_DATA);
    ...
    public static final COSName KEYWORDS = new COSName(AdobePDFSchema.KEYWORDS);
    ...
    public static final COSName NAMES = new COSName(OECFType.NAMES);
    ...
    public static final COSName PRODUCER = new COSName(AdobePDFSchema.PRODUCER);
    ...
    public static final COSName Q = new COSName(OperatorName.RESTORE);
    ...
    public static final COSName STATE = new COSName(PhotoshopSchema.STATE);
    ...
    public String toString() {
        return "COSName{" + this.name + StringSubstitutor.DEFAULT_VAR_END;
    }
