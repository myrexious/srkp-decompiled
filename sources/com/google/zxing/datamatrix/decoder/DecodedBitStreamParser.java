...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', '$', '%', Typography.amp, '\'', '(', ')', '*', '+', ',', Soundex.SILENT_MARKER, '.', '/', ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', IOUtils.DIR_SEPARATOR_WINDOWS, ']', '^', '_'};
    ...
    private static int unrandomize255State(int i, int i2) {
        int i3 = i - (((i2 * BuiltinOperator.MULTINOMIAL) % 255) + 1);
