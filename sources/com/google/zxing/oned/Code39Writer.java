...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        toIntArray(BuiltinOperator.RANDOM_UNIFORM, iArr);
                ...
                if (charAt != ' ') {
                    if (charAt == '@') {
                        ...
                        if (charAt <= 26) {
                            ...
                            throw new IllegalArgumentException("Requested content contains a non-encodable character: '" + str.charAt(i) + OperatorName.SHOW_TEXT_LINE);
                        }
                    }
                }
                sb.append(charAt);
