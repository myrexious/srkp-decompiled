...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {BuiltinOptions.SliceOptions, 49, 50, 51, 52, 53, 54, 55, BuiltinOptions.PowOptions, BuiltinOptions.ArgMinOptions, BuiltinOptions.DequantizeOptions, 13, 9, BuiltinOptions.GreaterOptions, BuiltinOptions.FakeQuantOptions, BuiltinOptions.SplitOptions, BuiltinOptions.GreaterEqualOptions, BuiltinOptions.LessEqualOptions, BuiltinOptions.LogSoftmaxOptions, BuiltinOptions.SelectOptions, BuiltinOptions.PadV2Options, BuiltinOptions.CastOptions, BuiltinOptions.NegOptions, 61, BuiltinOptions.DepthToSpaceOptions, 0, 32, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {BuiltinOptions.PackOptions, BuiltinOptions.LogicalOrOptions, BuiltinOptions.LogicalAndOptions, BuiltinOptions.UnpackOptions, BuiltinOptions.HardSwishOptions, BuiltinOptions.IfOptions, BuiltinOptions.WhileOptions, BuiltinOptions.NonMaxSuppressionV4Options, BuiltinOptions.NonMaxSuppressionV5Options, 126, BuiltinOptions.ExpOptions, 13, 9, BuiltinOptions.GreaterOptions, BuiltinOptions.FakeQuantOptions, 10, BuiltinOptions.GreaterEqualOptions, BuiltinOptions.LessEqualOptions, BuiltinOptions.LogSoftmaxOptions, BuiltinOptions.SelectOptions, BuiltinOptions.TopKV2Options, 124, BuiltinOptions.NegOptions, BuiltinOptions.ArgMaxOptions, BuiltinOptions.LessOptions, BuiltinOptions.LogicalNotOptions, 123, 125, BuiltinOptions.MaximumMinimumOptions, 0};
    ...
    /* JADX WARN: Removed duplicated region for block: B:178:0x00f6 A[EDGE_INSN: B:178:0x00f6->B:157:0x00f6 ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:197:0x000f A[SYNTHETIC] */
    /*
