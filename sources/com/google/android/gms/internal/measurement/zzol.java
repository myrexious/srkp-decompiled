...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzb = zza2.zzd("measurement.app_uninstalled_additional_ad_id_cache_time", DateUtils.MILLIS_PER_HOUR);
        zzc = zza2.zzd("measurement.max_bundles_per_iteration", 100L);
        zzd = zza2.zzd("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        ...
        zzn = zza2.zzd("measurement.alarm_manager.minimum_interval", DateUtils.MILLIS_PER_MINUTE);
        zzo = zza2.zzd("measurement.upload.minimum_delay", 500L);
        zzp = zza2.zzd("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        zzq = zza2.zzd("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        zzr = zza2.zzd("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zzs = zza2.zzd("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        zzt = zza2.zzd("measurement.service_client.idle_disconnect_millis", 5000L);
        zzu = zza2.zze("measurement.log_tag.service", "FA-SVC");
        zzv = zza2.zzd("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzA = zza2.zzd("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        zzB = zza2.zzd("measurement.upload.max_bundle_size", 65536L);
        ...
        zzK = zza2.zzd("measurement.upload.max_batch_size", 65536L);
        ...
        zzO = zza2.zzd("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
    }
