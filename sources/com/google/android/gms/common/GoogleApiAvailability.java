...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(Context context, int i) {
        zae(context, i, null, getErrorResolutionPendingIntent(context, i, 0, OperatorName.ENDPATH));
    }
    ...
    public final boolean zag(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa(activity, i, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i, OperatorName.SET_LINE_DASHPATTERN), 2), onCancelListener);
        if (zaa2 == null) {
            return false;
        }
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, OperatorName.SET_LINE_DASHPATTERN), i2), onCancelListener);
    }
    ...
    public Dialog getErrorDialog(Fragment fragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, OperatorName.SET_LINE_DASHPATTERN), i2), onCancelListener);
    }
}
