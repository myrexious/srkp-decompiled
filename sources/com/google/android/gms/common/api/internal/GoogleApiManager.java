        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabqVar.zaD(new Status(17, sb.toString()));
                        break;
                    } else {
                        apiKey = ((zabq) zabqVar).zad;
            ...
            case 10:
                for (ApiKey<?> apiKey7 : this.zas) {
                    zabq<?> remove = this.zap.remove(apiKey7);
                    if (remove != null) {
                        remove.zav();
                    }
                }
            ...
            case 15:
                ...
                if (map.containsKey(apiKey2)) {
                    ...
                    apiKey3 = zabsVar.zaa;
                    zabq.zal(map2.get(apiKey3), zabsVar);
                    break;
                }
                break;
            case 16:
                ...
                if (map3.containsKey(apiKey4)) {
                    ...
                    zabq.zam(map4.get(apiKey5), zabsVar2);
                    break;
                }
                break;
            case 17:
