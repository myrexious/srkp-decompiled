...
public class ClockHandView extends View {
    ...
    public void setHandRotation(float f, boolean z) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.ClockHandView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ClockHandView.this.m193xb17f7076(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m193xb17f7076(ValueAnimator valueAnimator) {
    ...
    private void drawSelector(Canvas canvas) {
        ...
        canvas.drawCircle((((float) Math.cos(this.degRad)) * leveledCircleRadius2) + f, (leveledCircleRadius2 * ((float) Math.sin(this.degRad))) + f2, this.selectorRadius, this.paint);
        double sin = Math.sin(this.degRad);
        double cos = Math.cos(this.degRad);
        this.paint.setStrokeWidth(this.selectorStrokeWidth);
        canvas.drawLine(f, f2, width + ((int) (cos * r7)), height + ((int) (r7 * sin)), this.paint);
