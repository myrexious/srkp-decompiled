...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(ThumbnailType.WIDTH)) {
            arrayList.add(motionSpec.getAnimator(ThumbnailType.WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(ThumbnailType.HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(ThumbnailType.HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
