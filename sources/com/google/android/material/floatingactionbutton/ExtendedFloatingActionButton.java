...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, ThumbnailType.WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, ThumbnailType.HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    */
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(ThumbnailType.WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(ThumbnailType.WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(ThumbnailType.WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(ThumbnailType.HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(ThumbnailType.HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(ThumbnailType.HEIGHT, propertyValues2);
            }
