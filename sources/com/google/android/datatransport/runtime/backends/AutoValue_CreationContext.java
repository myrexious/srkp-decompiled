...
public final class AutoValue_CreationContext extends CreationContext {
    ...
    public String toString() {
        return "CreationContext{applicationContext=" + this.applicationContext + ", wallClock=" + this.wallClock + ", monotonicClock=" + this.monotonicClock + ", backendName=" + this.backendName + StringSubstitutor.DEFAULT_VAR_END;
    }
