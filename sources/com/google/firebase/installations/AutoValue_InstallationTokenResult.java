...
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public String toString() {
        return "InstallationTokenResult{token=" + this.token + ", tokenExpirationTimestamp=" + this.tokenExpirationTimestamp + ", tokenCreationTimestamp=" + this.tokenCreationTimestamp + StringSubstitutor.DEFAULT_VAR_END;
    }
