...
public class FileStore {
    ...
    public FileStore(Context context) {
        ...
        File prepareBaseDir = prepareBaseDir(new File(filesDir, useV2FileSystem() ? CRASHLYTICS_PATH_V2 + File.pathSeparator + sanitizeName(Application.getProcessName()) : CRASHLYTICS_PATH_V1));
