...
public class DevelopmentPlatformProvider {
    ...
    public class DevelopmentPlatform {
        ...
        private DevelopmentPlatform() {
            DevelopmentPlatformProvider.this = r4;
            int resourcesIdentifier = CommonUtils.getResourcesIdentifier(r4.context, DevelopmentPlatformProvider.UNITY_VERSION_FIELD, TypedValues.Custom.S_STRING);
            if (resourcesIdentifier == 0) {
                if (r4.assetFileExists(DevelopmentPlatformProvider.FLUTTER_ASSET_FILE)) {
            ...
            String string = r4.context.getResources().getString(resourcesIdentifier);
