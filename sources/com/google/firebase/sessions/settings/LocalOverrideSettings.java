...
public final class LocalOverrideSettings implements SettingsProvider {
    ...
    public LocalOverrideSettings(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            bundle = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.ApplicationInfoFlags.of(128L)).metaData;
        } else {
    ...
    public Duration mo249getSessionRestartTimeoutFghU774() {
        if (this.metadata.containsKey(SESSION_RESTART_TIMEOUT)) {
            return Duration.m1599boximpl(DurationKt.toDuration(this.metadata.getInt(SESSION_RESTART_TIMEOUT), DurationUnit.SECONDS));
        }
        return null;
    }
