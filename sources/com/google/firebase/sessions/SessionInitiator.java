...
public final class SessionInitiator {
    ...
    public SessionInitiator(TimeProvider timeProvider, CoroutineContext backgroundDispatcher, SessionInitiateListener sessionInitiateListener, SessionsSettings sessionsSettings, SessionGenerator sessionGenerator) {
        ...
        this.backgroundTime = timeProvider.mo248elapsedRealtimeUwyO8pc();
        initiateSession();
    ...
    public final void appBackgrounded() {
        this.backgroundTime = this.timeProvider.mo248elapsedRealtimeUwyO8pc();
    }

    public final void appForegrounded() {
        if (Duration.m1600compareToLRDsOJo(Duration.m1636minusLRDsOJo(this.timeProvider.mo248elapsedRealtimeUwyO8pc(), this.backgroundTime), this.sessionsSettings.m251getSessionRestartTimeoutUwyO8pc()) > 0) {
            initiateSession();
        }
    }
