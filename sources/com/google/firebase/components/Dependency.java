...
public final class Dependency {
    ...
    public String toString() {
        ...
        int i = this.type;
        return append.append(i == 1 ? "required" : i == 0 ? "optional" : "set").append(", injection=").append(describeInjection(this.injection)).append(StringSubstitutor.DEFAULT_VAR_END).toString();
    }
