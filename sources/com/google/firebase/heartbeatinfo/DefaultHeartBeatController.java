...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.DefaultHeartBeatController$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return DefaultHeartBeatController.this.m225x734756b4();
            }
        });
    }

    /* renamed from: lambda$registerHeartBeat$0$com-google-firebase-heartbeatinfo-DefaultHeartBeatController */
    public /* synthetic */ Void m225x734756b4() throws Exception {
        synchronized (this) {
    ...
    public Task<String> getHeartBeatsHeader() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.DefaultHeartBeatController$$ExternalSyntheticLambda0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return DefaultHeartBeatController.this.m224x341e14f2();
            }
        });
    }

    /* renamed from: lambda$getHeartBeatsHeader$1$com-google-firebase-heartbeatinfo-DefaultHeartBeatController */
    public /* synthetic */ String m224x341e14f2() throws Exception {
        ...
        synchronized (this) {
            ...
            jSONObject2.put(VersionType.VERSION, ExifInterface.GPS_MEASUREMENT_2D);
