...
public class TypeKey {
    ...
    public final String toString() {
        if (this._class != null) {
            return "{class: " + this._class.getName() + ", typed? " + this._isTyped + StringSubstitutor.DEFAULT_VAR_END;
        }
        return "{type: " + this._type + ", typed? " + this._isTyped + StringSubstitutor.DEFAULT_VAR_END;
    }
