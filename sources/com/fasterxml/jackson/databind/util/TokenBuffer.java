...
public class TokenBuffer extends JsonGenerator {
    ...
    public void writeString(Reader reader, int i) throws IOException {
        ...
        while (i2 > 0) {
            int read = reader.read(cArr, 0, Math.min(i2, 1000));
            if (read <= 0) {
                break;
            }
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            if (numberValue instanceof Integer) {
                return BigDecimal.valueOf(numberValue.intValue());
            }
        ...
        private Number getNumberValue(boolean z) throws IOException {
            ...
            if (_currentObject instanceof String) {
                ...
                if (this._currToken == JsonToken.VALUE_NUMBER_INT) {
                    ...
                    throw new IllegalStateException("Internal error: failed to parse number '" + str + OperatorName.SHOW_TEXT_LINE);
                } else {
