...
public class TypeFactory implements Serializable {
    ...
    private JavaType _mapType(Class<?> cls, TypeBindings typeBindings, JavaType javaType, JavaType[] javaTypeArr) {
        ...
        if (cls == Properties.class) {
            ...
            if (size != 0) {
                ...
                objArr[2] = size == 1 ? "" : OperatorName.CLOSE_AND_STROKE;
    ...
    public JavaType _fromClass(ClassStack classStack, Class<?> cls, TypeBindings typeBindings) {
        ...
        JavaType javaType2 = asKey == null ? null : this._typeCache.get(asKey);
        if (javaType2 != null) {
            return javaType2;
        }
        if (classStack == null) {
        ...
        if (cls.isArray()) {
            ...
            if (cls.isInterface()) {
                ...
                javaType = _resolveSuperClass(child, cls, typeBindings);
                _resolveSuperInterfaces = _resolveSuperInterfaces(child, cls, typeBindings);
            }
            ...
            _newSimpleType = (javaType2 == null && (javaType2 = _fromWellKnownClass(child, cls, typeBindings, javaType, javaTypeArr)) == null && (javaType2 = _fromWellKnownInterface(child, cls, typeBindings, javaType, javaTypeArr)) == null) ? _newSimpleType(cls, typeBindings, javaType, javaTypeArr) : javaType2;
        }
        child.resolveSelfReferences(_newSimpleType);
        if (asKey != null && !_newSimpleType.hasHandlers()) {
