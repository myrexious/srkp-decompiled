...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    public static final class EnumKD extends StdKeyDeserializer {
        ...
        public EnumKD(EnumResolver enumResolver, AnnotatedMethod annotatedMethod, EnumResolver enumResolver2) {
            super(-1, enumResolver.getEnumClass());
            this._byNameResolver = enumResolver;
            this._factory = annotatedMethod;
            this._enumDefaultValue = enumResolver.getDefaultValue();
        ...
        public Object _parse(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            if (findEnum == null) {
                if (this._enumDefaultValue == null || !deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE)) {
                    return !deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL) ? deserializationContext.handleWeirdKey(this._keyClass, str, "not one of the values accepted for Enum class: %s", _resolveCurrentResolver.getEnumIds()) : findEnum;
                }
        ...
        private EnumResolver _getToStringResolver(DeserializationContext deserializationContext) {
            ...
            if (enumResolver == null) {
                synchronized (this) {
                    ...
                    if (enumResolver == null) {
                        EnumResolver constructUsingToString = EnumResolver.constructUsingToString(deserializationContext.getConfig(), this._byNameResolver.getEnumClass());
                        this._byToStringResolver = constructUsingToString;
        ...
        private EnumResolver _getIndexResolver(DeserializationContext deserializationContext) {
            ...
            if (enumResolver == null) {
                synchronized (this) {
                    ...
                    if (enumResolver == null) {
                        EnumResolver constructUsingIndex = EnumResolver.constructUsingIndex(deserializationContext.getConfig(), this._byNameResolver.getEnumClass());
                        this._byIndexResolver = constructUsingIndex;
