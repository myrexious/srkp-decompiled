...
public class JsonFactory extends TokenStreamFactory implements Versioned, Serializable {
    ...
    public JsonFactory(JsonFactoryBuilder jsonFactoryBuilder) {
        ...
        this._streamReadConstraints = jsonFactoryBuilder._streamReadConstraints == null ? StreamReadConstraints.defaults() : jsonFactoryBuilder._streamReadConstraints;
    ...
    protected JsonFactory(TSFBuilder<?, ?> tSFBuilder, boolean z) {
        ...
        this._streamReadConstraints = tSFBuilder._streamReadConstraints == null ? StreamReadConstraints.defaults() : tSFBuilder._streamReadConstraints;
    ...
    protected IOContext _createContext(Object obj, boolean z) {
        return new IOContext(this._streamReadConstraints, _getBufferRecycler(), _createContentReference(obj), z);
    }

    protected IOContext _createNonBlockingContext(Object obj) {
        return new IOContext(this._streamReadConstraints, _getBufferRecycler(), _createContentReference(obj), false);
    }
