...
public class UTF8DataInputJsonParser extends ParserBase {
    ...
    */
    ...
    protected JsonToken _parseUnsignedNumber(int i) throws IOException {
        ...
        if (i == 48) {
            ...
            if (readUnsignedByte <= 57 && readUnsignedByte >= 48) {
                i2 = 0;
            } else if (readUnsignedByte == 120 || readUnsignedByte == 88) {
    ...
    private final JsonToken _parseSignedNumber(boolean z) throws IOException {
        ...
        int i2 = i + 1;
        emptyAndGetCurrentSegment[i] = (char) readUnsignedByte2;
        ...
        if (i4 == 46 || i4 == 101 || i4 == 69) {
            return _parseFloat(cArr, i5, i4, z, i3);
        }
