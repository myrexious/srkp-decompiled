...
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:54:0x0021 A[EDGE_INSN: B:54:0x0021->B:41:0x0021 ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:62:0x001f A[EDGE_INSN: B:62:0x001f->B:46:0x001f ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:69:0x0038 A[EDGE_INSN: B:69:0x0038->B:56:0x0038 ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x0036 A[EDGE_INSN: B:76:0x0036->B:61:0x0036 ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
        ...
        if (i >= 0) {
            ...
            if (i5 >= 6) {
                ...
                if (c > 255) {
                    int i8 = (c >> '\b') & 255;
                    int i9 = i7 + 1;
                    cArr3[i9] = hexChars[i8 >> 4];
                    i2 = i9 + 1;
                    cArr3[i2] = hexChars[i8 & 15];
                    c = (char) (c & VpRGBa.alphaDefault);
                } else {
                    int i10 = i7 + 1;
                    cArr3[i10] = '0';
                    i2 = i10 + 1;
            ...
            if (c > 255) {
                int i12 = (c >> '\b') & 255;
                int i13 = c & VpRGBa.alphaDefault;
                cArr4[10] = hexChars[i12 >> 4];
                cArr4[11] = hexChars[i12 & 15];
                cArr4[12] = hexChars[i13 >> 4];
                cArr4[13] = hexChars[i13 & 15];
                this._writer.write(cArr4, 8, 6);
                return;
            }
            cArr4[6] = hexChars[c >> 4];
            cArr4[7] = hexChars[c & 15];
        ...
        if (i3 >= 0) {
            ...
            if (i > 5 && i < i2) {
                ...
                if (c > 255) {
                    int i9 = (c >> '\b') & 255;
                    int i10 = i8 + 1;
                    cArr[i8] = hexChars[i9 >> 4];
                    i4 = i10 + 1;
                    cArr[i10] = hexChars[i9 & 15];
                    c = (char) (c & VpRGBa.alphaDefault);
                } else {
                    int i11 = i8 + 1;
                    cArr[i8] = '0';
            ...
            if (c > 255) {
                int i13 = (c >> '\b') & 255;
                int i14 = c & VpRGBa.alphaDefault;
                cArr3[10] = hexChars[i13 >> 4];
                cArr3[11] = hexChars[i13 & 15];
                cArr3[12] = hexChars[i14 >> 4];
                cArr3[13] = hexChars[i14 & 15];
    ...
    private void _appendCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i >= 0) {
            ...
            if (c > 255) {
                int i8 = 255 & (c >> '\b');
                int i9 = i7 + 1;
                cArr2[i7] = hexChars[i8 >> 4];
                i2 = i9 + 1;
                cArr2[i9] = hexChars[i8 & 15];
                c = (char) (c & VpRGBa.alphaDefault);
            } else {
                int i10 = i7 + 1;
                cArr2[i7] = '0';
