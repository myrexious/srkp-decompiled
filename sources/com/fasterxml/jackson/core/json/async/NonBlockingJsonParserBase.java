...
public abstract class NonBlockingJsonParserBase extends ParserBase {
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(_contentReference(), this._currInputProcessed + (this._inputPtr - this._currBufferStart), -1L, Math.max(this._currInputRow, this._currInputRowAlt), i);
    }
    ...
    */
    public final java.lang.String _addName(int[] r17, int r18, int r19) throws com.fasterxml.jackson.core.JsonParseException, com.fasterxml.jackson.core.exc.StreamConstraintsException {
        /*
