...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    */
    ...
    private final JsonToken _parseSignedNumber(boolean z) throws IOException {
        ...
        int min = Math.min(this._inputEnd, (this._inputPtr + emptyAndGetCurrentSegment.length) - i4);
        int i5 = i4;
        int i6 = 1;
        while (this._inputPtr < min) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final java.lang.String addName(int[] r17, int r18, int r19) throws com.fasterxml.jackson.core.JsonParseException, com.fasterxml.jackson.core.exc.StreamConstraintsException {
        /*
    ...
    */
    ...
    protected final void _matchTrue() throws IOException {
        ...
        _matchToken2(BooleanUtils.TRUE, 1);
    }
    ...
    protected final void _matchFalse() throws IOException {
        ...
        _matchToken2(BooleanUtils.FALSE, 1);
    }
    ...
    */
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        ...
        return ((i & 31) << 6) | (b & BuiltinOptions.LogicalNotOptions);
    }
    ...
    private final int _decodeUtf8_3(int i) throws IOException {
        ...
        int i4 = (i2 << 6) | (b & BuiltinOptions.LogicalNotOptions);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr2 = this._inputBuffer;
        ...
        return (i4 << 6) | (b2 & BuiltinOptions.LogicalNotOptions);
    }
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        int i3 = ((i & 7) << 6) | (b & BuiltinOptions.LogicalNotOptions);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr2 = this._inputBuffer;
        ...
        int i5 = (i3 << 6) | (b2 & BuiltinOptions.LogicalNotOptions);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr3 = this._inputBuffer;
        ...
        return ((i5 << 6) | (b3 & BuiltinOptions.LogicalNotOptions)) - 65536;
    }
