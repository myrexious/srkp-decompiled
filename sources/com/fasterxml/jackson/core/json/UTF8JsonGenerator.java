...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    private static final byte[] NULL_BYTES = {BuiltinOptions.HashtableSizeOptions, 117, BuiltinOptions.HashtableFindOptions, BuiltinOptions.HashtableFindOptions};
    private static final byte[] TRUE_BYTES = {BuiltinOptions.GeluOptions, BuiltinOptions.RandomOptions, 117, BuiltinOptions.BatchMatMulOptions};
    private static final byte[] FALSE_BYTES = {BuiltinOptions.CumsumOptions, BuiltinOptions.ScatterNdOptions, BuiltinOptions.HashtableFindOptions, BuiltinOptions.BucketizeOptions, BuiltinOptions.BatchMatMulOptions};
    ...
    */
    ...
    protected final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            if (maxLineLength <= 0) {
                ...
                bArr2[i8] = BuiltinOptions.HashtableSizeOptions;
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            if (maxLineLength <= 0) {
                ...
                bArr2[i9] = BuiltinOptions.HashtableSizeOptions;
                maxLineLength = base64Variant.getMaxLineLength() >> 2;
            }
        }
    ...
    private final int _outputMultiByteChar(int i, int i2) throws IOException {
        ...
        if (i >= 55296 && i <= 57343) {
            ...
            bArr[i3] = 117;
            int i5 = i4 + 1;
            bArr[i4] = hexBytes[(i >> 12) & 15];
            int i6 = i5 + 1;
            bArr[i5] = hexBytes[(i >> 8) & 15];
            int i7 = i6 + 1;
            bArr[i6] = hexBytes[(i >> 4) & 15];
            int i8 = i7 + 1;
            bArr[i7] = hexBytes[i & 15];
            return i8;
        }
        int i9 = i2 + 1;
