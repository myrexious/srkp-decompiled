...
public class Base64 {
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int i, int i2, int i3) {
        ...
        if (i14 == 1) {
            ...
            int i20 = i2 + 1;
            int i21 = i20 + 1;
            int i22 = ((source[i20] & UByte.MAX_VALUE) << 2) | ((source[i2] & UByte.MAX_VALUE) << 10);
            int i23 = i5 + 1;
    ...
    private final int decodeImpl(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            if (i6 == i4 && i8 + 3 < i3) {
                ...
                int i13 = i11 + 1;
                int i14 = iArr[bArr[i11] & UByte.MAX_VALUE];
                int i15 = i13 + 1;
                int i16 = (i14 << 6) | (i10 << 18) | (i12 << 12) | iArr[bArr[i13] & UByte.MAX_VALUE];
                if (i16 >= 0) {
                    int i17 = i5 + 1;
            ...
            if (i20 >= 0) {
                ...
                StringBuilder append = new StringBuilder("Invalid symbol '").append((char) i19).append("'(");
                String num = Integer.toString(i19, CharsKt.checkRadix(8));
                Intrinsics.checkNotNullExpressionValue(num, "toString(this, checkRadix(radix))");
                throw new IllegalArgumentException(append.append(num).append(") at index ").append(i8).toString());
            } else {
                i8++;
            }
            i4 = -8;
        ...
        StringBuilder append2 = new StringBuilder("Symbol '").append((char) i21).append("'(");
    ...
    public final byte[] charsToBytesImpl$kotlin_stdlib(CharSequence source, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (charAt <= 255) {
                ...
                bArr[i3] = BuiltinOptions.LogicalNotOptions;
                i3++;
            }
            i++;
        }
