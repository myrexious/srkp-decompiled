...
public final class FileTreeWalk implements Sequence<File> {
    ...
    public final class FileTreeWalkIterator extends AbstractIterator<File> {
        ...
        public FileTreeWalkIterator() {
            FileTreeWalk.this = r3;
            ArrayDeque<WalkState> arrayDeque = new ArrayDeque<>();
            this.state = arrayDeque;
            if (r3.start.isDirectory()) {
                arrayDeque.push(directoryState(r3.start));
            } else if (r3.start.isFile()) {
                arrayDeque.push(new SingleFileState(this, r3.start));
            } else {
                done();
            }
        }
