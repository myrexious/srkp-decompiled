...
public interface TimeMark {
    ...
    TimeMark mo1591minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1593plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo */
        public static TimeMark m1738plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo */
        public static TimeMark m1737minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1593plusLRDsOJo(Duration.m1653unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1634isNegativeimpl(timeMark.mo1590elapsedNowUwyO8pc());
        }
