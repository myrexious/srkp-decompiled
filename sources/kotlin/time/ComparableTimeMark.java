...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1591minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1592minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1593plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo */
        public static ComparableTimeMark m1596minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1593plusLRDsOJo(Duration.m1653unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1600compareToLRDsOJo(comparableTimeMark.mo1592minusUwyO8pc(other), Duration.Companion.m1703getZEROUwyO8pc());
        }
    }
}
