...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m786containsVKZWuLQ(((ULong) obj).m501unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m443boximpl(m787getsVKNKU(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m788indexOfVKZWuLQ(((ULong) obj).m501unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m789lastIndexOfVKZWuLQ(((ULong) obj).m501unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return ULongArray.m510getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m512isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ */
    public boolean m786containsVKZWuLQ(long j) {
        return ULongArray.m505containsVKZWuLQ(this.$this_asList, j);
    }

    /* renamed from: get-s-VKNKU */
    public long m787getsVKNKU(int i) {
        return ULongArray.m509getsVKNKU(this.$this_asList, i);
    }

    /* renamed from: indexOf-VKZWuLQ */
    public int m788indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ */
    public int m789lastIndexOfVKZWuLQ(long j) {
