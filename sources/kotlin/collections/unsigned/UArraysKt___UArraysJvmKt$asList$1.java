...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m782containsWZ4Q5Ns(((UInt) obj).m422unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UInt.m364boximpl(m783getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m784indexOfWZ4Q5Ns(((UInt) obj).m422unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m785lastIndexOfWZ4Q5Ns(((UInt) obj).m422unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m431getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m433isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns */
    public boolean m782containsWZ4Q5Ns(int i) {
        return UIntArray.m426containsWZ4Q5Ns(this.$this_asList, i);
    }

    /* renamed from: get-pVg5ArA */
    public int m783getpVg5ArA(int i) {
        return UIntArray.m430getpVg5ArA(this.$this_asList, i);
    }

    /* renamed from: indexOf-WZ4Q5Ns */
    public int m784indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns */
    public int m785lastIndexOfWZ4Q5Ns(int i) {
