...
public final class SlidingWindowKt$windowedIterator$1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super List<? extends T>>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:138:0x00e5 A[RETURN] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:123:0x00a9 -> B:111:0x0058). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:152:0x0130 -> B:154:0x0133). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:165:0x0168 -> B:167:0x016b). Please submit an issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
