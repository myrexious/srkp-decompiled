...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* JADX WARN: Removed duplicated region for block: B:101:0x00a8 A[EDGE_INSN: B:101:0x00a8->B:94:0x00a8 ?: BREAK  , SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:91:0x00a1 A[EDGE_INSN: B:91:0x00a1->B:87:0x00a1 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b & ByteCompanionObject.MIN_VALUE) == 0) {
            ...
            i = b & BuiltinOptions.SequenceRNNOptions;
            i2 = 2;
            i3 = 128;
        } else if ((b & 240) == 224) {
            i = b & 15;
        ...
        for (int i4 = 1; i4 < i2; i4++) {
            ...
            i = (i << 6) | (b2 & BuiltinOptions.LogicalNotOptions);
        }
        skip(j);
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (z) {
            bArr[i3 - 1] = BuiltinOptions.GreaterEqualOptions;
        }
