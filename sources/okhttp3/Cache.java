...
public final class Cache implements Closeable, Flushable {
    ...
    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() { // from class: okhttp3.Cache.2
            ...
            {
                Cache.this = this;
                this.delegate = this.cache.snapshots();
            }
            ...
            try {
                ...
                if (isHttps()) {
                    ...
                    if (readUtf8LineStrict.length() > 0) {
                        throw new IOException("expected \"\" but was \"" + readUtf8LineStrict + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
                    }
    ...
    static int readInt(BufferedSource bufferedSource) throws IOException {
        try {
            ...
            if (readDecimalLong < 0 || readDecimalLong > 2147483647L || !readUtf8LineStrict.isEmpty()) {
                throw new IOException("expected an int but was \"" + readDecimalLong + readUtf8LineStrict + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            }
