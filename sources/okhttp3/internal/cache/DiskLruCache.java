...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        Editor(Entry entry) {
            DiskLruCache.this = r1;
            this.entry = entry;
            this.written = entry.readable ? null : new boolean[r1.valueCount];
        }
    ...
    public final class Entry {
        ...
        Entry(String str) {
            ...
            for (int i = 0; i < r7.valueCount; i++) {
                append.append(i);
                this.cleanFiles[i] = new File(r7.directory, append.toString());
                append.append(".tmp");
                this.dirtyFiles[i] = new File(r7.directory, append.toString());
