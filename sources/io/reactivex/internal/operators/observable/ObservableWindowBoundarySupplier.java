        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.s, disposable)) {
                ...
                try {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.boundary, null, windowBoundaryInnerObserver)) {
                    ...
                    if (poll == NEXT) {
                        ...
                        if (this.windows.decrementAndGet() == 0) {
                            ...
                            try {
                                ...
                                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, atomicReference.get(), windowBoundaryInnerObserver)) {
                                    observableSource.subscribe(windowBoundaryInnerObserver);
                                }
