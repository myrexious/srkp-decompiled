            ...
            if (SubscriptionHelper.validate(this.s, subscription)) {
                ...
                try {
                    ...
                    if (requested != 0) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.boundary, null, windowBoundaryInnerSubscriber)) {
                        ...
                        if (this.windows.decrementAndGet() == 0) {
                            ...
                            try {
                                ...
                                if (requested != 0) {
                                    ...
                                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, atomicReference.get(), windowBoundaryInnerSubscriber)) {
                                        publisher.subscribe(windowBoundaryInnerSubscriber);
                                    }
                                } else {
                                    this.cancelled = true;
