...
public class CameraRenderer extends CameraGLRendererBase {
    ...
    */
    protected synchronized void openCamera(int r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.visp.android.CameraRenderer.openCamera(int):void");
    }
    ...
    */
    public synchronized void setCameraPreviewSize(int r14, int r15) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.visp.android.CameraRenderer.setCameraPreviewSize(int, int):void");
    }
}
