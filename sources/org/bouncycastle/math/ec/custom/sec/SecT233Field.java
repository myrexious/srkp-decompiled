...
public class SecT233Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 3; i < i2; i2 = 3) {
            ...
            int i4 = i3 >>> 6;
            int i5 = i3 & 63;
            createExt64[i4] = createExt64[i4] ^ (j7 << i5);
            int i6 = i4 + 1;
            int i7 = -i5;
            createExt64[i6] = createExt64[i6] ^ ((j6 << i5) | (j7 >>> i7));
            int i8 = i4 + 2;
            createExt64[i8] = createExt64[i8] ^ ((j5 << i5) | (j6 >>> i7));
            int i9 = i4 + 3;
            createExt64[i9] = createExt64[i9] ^ (j5 >>> i7);
            i++;
        }
        reduce(createExt64, jArr2);
        jArr2[0] = jArr2[0] ^ j;
