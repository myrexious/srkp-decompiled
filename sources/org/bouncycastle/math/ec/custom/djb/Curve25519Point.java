...
public class Curve25519Point extends ECPoint.AbstractFp {
    ...
    protected Curve25519Point twiceJacobianModified(boolean z) {
        ...
        if (z) {
            ...
            Curve25519Field.multiply(curve25519FieldElement.x, jacobianModifiedW.x, curve25519FieldElement.x);
            Curve25519Field.twice(curve25519FieldElement.x, curve25519FieldElement.x);
        } else {
