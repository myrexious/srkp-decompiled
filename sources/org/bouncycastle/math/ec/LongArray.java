...
public class LongArray implements Cloneable {
    ...
    private static final int[] INTERLEAVE3_TABLE = {0, 1, 8, 9, 64, 65, 72, 73, 512, 513, 520, 521, 576, 577, 584, 585, 4096, FragmentTransaction.TRANSIT_FRAGMENT_OPEN, 4104, 4105, 4160, 4161, 4168, 4169, 4608, 4609, 4616, 4617, 4672, 4673, 4680, 4681, 32768, TiffTagConstants.COMPRESSION_VALUE_EPSON_ERF_COMPRESSED, 32776, 32777, 32832, 32833, 32840, 32841, 33280, 33281, 33288, 33289, 33344, 33345, 33352, 33353, 36864, 36865, 36872, 36873, 36928, 36929, 36936, 36937, 37376, 37377, 37384, 37385, 37440, 37441, 37448, 37449, 262144, 262145, 262152, 262153, 262208, 262209, 262216, 262217, 262656, 262657, 262664, 262665, 262720, 262721, 262728, 262729, 266240, 266241, 266248, 266249, 266304, 266305, 266312, 266313, 266752, 266753, 266760, 266761, 266816, 266817, 266824, 266825, 294912, 294913, 294920, 294921, 294976, 294977, 294984, 294985, 295424, 295425, 295432, 295433, 295488, 295489, 295496, 295497, 299008, 299009, 299016, 299017, 299072, 299073, 299080, 299081, 299520, 299521, 299528, 299529, 299584, 299585, 299592, 299593};
    ...
    public LongArray(BigInteger bigInteger) {
        ...
        while (i3 >= 0) {
            ...
            int i5 = 0;
            while (i5 < 8) {
                j2 = (j2 << 8) | (byteArray[i] & UByte.MAX_VALUE);
                i5++;
                i++;
            }
            this.m_ints[i3] = j2;
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i4 >>> 8;
            i = i6 == 0 ? bitLengths[i4] + 16 : bitLengths[i6] + BuiltinOptions.BatchToSpaceNDOptions;
        }
        return i2 + i;
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i16 < i6) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                i4 = i16;
                addBoth(jArr7, i17, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) j3) & 15], i9);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i4 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i5, jArr, 0);
            return reduceResult(jArr, 0, i6, i, iArr);
        }
        int i7 = 15;
        int i8 = ((i3 + 15) + 63) >>> 6;
        int i9 = i8 * 8;
        ...
        while (i14 < 8) {
            int i15 = i13 + i8;
            shiftUp(jArr2, i4, jArr2, i15, i8, i14);
            i14++;
            i13 = i15;
        }
        int i16 = 0;
        while (true) {
            ...
            do {
                int i18 = i4;
                long j2 = jArr2[i17] >>> i16;
                int i19 = 0;
                while (true) {
                    int i20 = ((int) j2) & i7;
                    if (i20 != 0) {
                        add(jArr2, iArr2[i20] + i17, jArr2, i18, i8);
                    }
                    i19++;
                    if (i19 == 8) {
                        break;
        ...
        while (true) {
            int i23 = i22 - 1;
            if (i23 <= 1) {
                return reduceResult(jArr2, iArr2[1], i6, i, iArr);
            }
            if ((i23 & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i23 >>> 1], jArr2, iArr2[i23], i6, 16);
            } else {
                distribute(jArr2, iArr2[i23], iArr2[i23 - 1], iArr2[1], i6);
            }
            i22 = i23;
        }
    }
