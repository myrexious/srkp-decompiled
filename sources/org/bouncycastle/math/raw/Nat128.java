...
public abstract class Nat128 {
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i8 < 4) {
            ...
            iArr3[i9 + 3] = (int) j12;
            long j13 = j6 + (j12 >>> 32) + (iArr3[i7] & 4294967295L);
            iArr3[i9 + 4] = (int) j13;
            j6 = j13 >>> 32;
            i8++;
            i9 = i10;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i5 < 4) {
            ...
            iArr3[i5 + 3] = (int) j11;
            long j12 = j6 + (j11 >>> 32) + (iArr3[i4] & 4294967295L);
            iArr3[i5 + 4] = (int) j12;
            j6 = j12 >>> 32;
            i5 = i6;
            j = 4294967295L;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i11 <= 0) {
                ...
                int i22 = i21 >>> 31;
                int i23 = i2 + 7;
                iArr2[i23] = i22 | ((iArr2[i23] + ((int) (j18 >>> 32))) << 1);
                return;
            }
            i10 = i11;
        }
