...
public abstract class Nat {
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        long j = 0;
        for (int i3 = 0; i3 < i; i3++) {
            long mulWordAddTo = j + (mulWordAddTo(i, iArr[i3], iArr2, 0, iArr3, i3) & 4294967295L) + (iArr3[i2] & 4294967295L);
            iArr3[i3 + i] = (int) mulWordAddTo;
            j = mulWordAddTo >>> 32;
        }
        return (int) j;
    }
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        ...
        long j4 = j2 * (j >>> 32);
        int i5 = i3 + 1;
        long j5 = (j3 >>> 32) + j4 + (iArr[i5] & 4294967295L);
        iArr[i5] = (int) j5;
        int i6 = i3 + 2;
        long j6 = (j5 >>> 32) + (iArr[i6] & 4294967295L);
        iArr[i6] = (int) j6;
        if ((j6 >>> 32) == 0) {
            return 0;
        }
