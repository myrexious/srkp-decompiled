...
public class UTF8 {
    ...
    static {
        ...
        fill(bArr2, BuiltinOperator.MATRIX_DIAG, 115, (byte) 9);
        ...
        byte[] bArr4 = {S_ERR, S_ERR, S_ERR, S_ERR, 0, 48, 16, 64, 80, 32, 96};
        for (int i = 0; i < 128; i++) {
            byte b = bArr2[i];
        ...
        while (i < i3) {
            ...
            if (b < 0) {
                ...
                while (b2 >= 0) {
                    ...
                    int i7 = i5 + 1;
                    byte b3 = bArr[i5];
                    i6 = (i6 << 6) | (b3 & BuiltinOptions.LogicalNotOptions);
                ...
                if (i6 <= 65535) {
                    ...
                    i4 = i8 + 1;
                    cArr[i8] = (char) ((i6 & 1023) | GeneratorBase.SURR2_FIRST);
                }
                i = i5;
