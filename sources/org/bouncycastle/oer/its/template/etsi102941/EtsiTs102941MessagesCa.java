...
public class EtsiTs102941MessagesCa {
    ...
    static {
        ...
        EtsiTs102941Data = OERDefinition.seq(EtsiTs102941BaseTypes.Version.label(VersionType.VERSION), typeName2.label(FirebaseAnalytics.Param.CONTENT)).typeName("EtsiTs102941Data");
