...
public class EtsiTs102941BaseTypes {
    ...
    public static final OERDefinition.Builder Version = OERDefinition.integer(0, 255).typeName(AFMParser.VERSION);
}
