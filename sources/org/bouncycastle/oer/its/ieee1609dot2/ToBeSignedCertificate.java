...
public class ToBeSignedCertificate extends ASN1Object {
    ...
    /* renamed from: id */
    private final CertificateId f53id;
    ...
    public static class Builder {
        ...
        public Builder(ToBeSignedCertificate toBeSignedCertificate) {
            this.f54id = toBeSignedCertificate.f53id;
        ...
        public ToBeSignedCertificate createToBeSignedCertificate() {
            return new ToBeSignedCertificate(this.f54id, this.cracaId, this.crlSeries, this.validityPeriod, this.region, this.assuranceLevel, this.appPermissions, this.certIssuePermissions, this.certRequestPermissions, this.canRequestRollover, this.encryptionKey, this.verifyKeyIndicator);
        }
    ...
    private ToBeSignedCertificate(ASN1Sequence aSN1Sequence) {
        ...
        this.f53id = CertificateId.getInstance(it.next());
