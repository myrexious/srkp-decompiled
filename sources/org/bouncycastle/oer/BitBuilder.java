...
public class BitBuilder {
    private static final byte[] bits = {ByteCompanionObject.MIN_VALUE, BuiltinOptions.UnpackOptions, 32, 16, 8, 4, 2, 1};
    byte[] buf = new byte[1];
    int pos = 0;
    ...
    public void write7BitBytes(BigInteger bigInteger) {
        ...
        while (bitLength >= 0) {
            ...
            if (z) {
                writeBit(bitLength).writeBits(bigInteger.and(shiftLeft).shiftRight(i - 8).intValue(), 8, 7);
            }
