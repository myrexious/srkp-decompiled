...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToLittleEndian(iArr[0] ^ this.wKey[0], bArr2, i2);
        Pack.intToLittleEndian(iArr[1] ^ this.wKey[1], bArr2, i2 + 4);
        Pack.intToLittleEndian(iArr[2] ^ this.wKey[2], bArr2, i2 + 8);
        Pack.intToLittleEndian(iArr[3] ^ this.wKey[3], bArr2, i2 + 12);
    }
    ...
    protected void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        Pack.intToLittleEndian(this.wKey[131] ^ iArr[3], bArr2, i2 + 12);
    }
