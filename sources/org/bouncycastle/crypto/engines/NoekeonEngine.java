...
public class NoekeonEngine implements BlockCipher {
    ...
    private static final byte[] roundConstants = {ByteCompanionObject.MIN_VALUE, BuiltinOptions.ReducerOptions, 54, BuiltinOptions.HashtableFindOptions, -40, -85, BuiltinOptions.MirrorPadOptions, -102, BuiltinOptions.SelectOptions, BuiltinOptions.DepthToSpaceOptions, PSSSigner.TRAILER_IMPLICIT, BuiltinOptions.DensifyOptions, -58, -105, 53, BuiltinOptions.Conv3DOptions, -44};
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            bigEndianToInt = rotateLeft5 ^ (i19 & i20);
