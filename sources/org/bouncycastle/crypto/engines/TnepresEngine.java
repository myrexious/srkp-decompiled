...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int[] iArr = {r2, this.wKey[129] ^ Pack.bigEndianToInt(bArr, i + 8), this.wKey[130] ^ Pack.bigEndianToInt(bArr, i + 4), this.wKey[131] ^ Pack.bigEndianToInt(bArr, i)};
        int bigEndianToInt = this.wKey[128] ^ Pack.bigEndianToInt(bArr, i + 12);
        ib7(iArr, bigEndianToInt, iArr[1], iArr[2], iArr[3]);
