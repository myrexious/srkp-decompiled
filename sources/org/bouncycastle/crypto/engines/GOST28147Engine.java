...
public class GOST28147Engine implements BlockCipher {
    ...
    private int bytesToint(byte[] bArr, int i) {
        return ((bArr[i + 3] << BuiltinOptions.BatchToSpaceNDOptions) & ViewCompat.MEASURED_STATE_MASK) + ((bArr[i + 2] << 16) & 16711680) + ((bArr[i + 1] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) + (bArr[i] & UByte.MAX_VALUE);
    }
