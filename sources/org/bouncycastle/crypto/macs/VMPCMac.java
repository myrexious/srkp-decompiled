...
public class VMPCMac implements Mac {
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        for (int i2 = 1; i2 < 25; i2++) {
            ...
            byte[] bArr3 = this.T;
            byte b12 = this.g;
            bArr3[b12 & BuiltinOptions.SequenceRNNOptions] = (byte) (b11 ^ bArr3[b12 & BuiltinOptions.SequenceRNNOptions]);
    ...
    public void update(byte b) throws IllegalStateException {
        ...
        byte[] bArr2 = this.T;
        byte b13 = this.g;
        bArr2[b13 & BuiltinOptions.SequenceRNNOptions] = (byte) (b12 ^ bArr2[b13 & BuiltinOptions.SequenceRNNOptions]);
