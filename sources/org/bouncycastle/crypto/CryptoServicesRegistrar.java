...
public final class CryptoServicesRegistrar {
    ...
    public static SecureRandom getSecureRandom() {
        ...
        LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, defaultRandomProviderImpl);
    ...
    public static void setServicesConstraints(CryptoServicesConstraints cryptoServicesConstraints) {
        ...
        if (!preconfiguredConstraints || Properties.isOverrideSet("org.bouncycastle.constraints.allow_override")) {
