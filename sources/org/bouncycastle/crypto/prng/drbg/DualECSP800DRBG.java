...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    static {
        ...
        nistPoints = r2;
        ECCurve.Fp fp = (ECCurve.Fp) NISTNamedCurves.getByNameLazy("P-256").getCurve();
        ECCurve.Fp fp2 = (ECCurve.Fp) NISTNamedCurves.getByNameLazy("P-384").getCurve();
        ECCurve.Fp fp3 = (ECCurve.Fp) NISTNamedCurves.getByNameLazy("P-521").getCurve();
