...
public abstract class GCMUtil {
    ...
    public static void multiply(byte[] bArr, long[] jArr) {
        ...
        long implMul642 = implMul64(bigEndianToLong2, j2) << 1;
        long implMul643 = ((implMul64(bigEndianToLong ^ bigEndianToLong2, j ^ j2) << 1) ^ ((reverse6 ^ implMul64) ^ implMul642)) ^ ((implMul642 << 62) ^ (implMul642 << 57));
        long j3 = implMul643 >>> 7;
        Pack.longToBigEndian(reverse5 ^ (j3 ^ (((implMul643 >>> 1) ^ implMul643) ^ (implMul643 >>> 2))), bArr, 0);
        Pack.longToBigEndian(((Longs.reverse(implMul64(reverse ^ reverse2, reverse3 ^ reverse4)) ^ ((implMul64 ^ reverse5) ^ reverse6)) ^ (((implMul642 ^ (implMul642 >>> 1)) ^ (implMul642 >>> 2)) ^ (implMul642 >>> 7))) ^ ((implMul643 << 57) ^ ((implMul643 << 63) ^ (implMul643 << 62))), bArr, 8);
    }
