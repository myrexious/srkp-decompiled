...
public class SkeinEngine implements Memoable {
    ...
    public static class Configuration {
        ...
        public Configuration(long j) {
            ...
            this.bytes = bArr;
            bArr[0] = BuiltinOptions.GatherNdOptions;
            bArr[1] = BuiltinOptions.FloorModOptions;
            bArr[2] = BuiltinOptions.FloorDivOptions;
            bArr[3] = 51;
            bArr[4] = 1;
            bArr[5] = 0;
    ...
    private void output(long j, byte[] bArr, int i, int i2) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            ...
            if (min == 8) {
                Pack.longToLittleEndian(jArr[i4], bArr, i5 + i);
            } else {
                Pack.longToLittleEndian(jArr[i4], bArr2, 0);
