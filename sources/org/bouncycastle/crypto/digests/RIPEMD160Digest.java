...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        Pack.intToLittleEndian(this.H0, bArr, i);
        Pack.intToLittleEndian(this.H1, bArr, i + 4);
        Pack.intToLittleEndian(this.H2, bArr, i + 8);
        Pack.intToLittleEndian(this.H3, bArr, i + 12);
        Pack.intToLittleEndian(this.H4, bArr, i + 16);
        reset();
        return 20;
    }
    ...
    protected void processBlock() {
        ...
        int RL287 = RL(RL283, 10);
        int RL288 = RL(RL252 + f1(RL255, RL253, RL256) + this.X[12], 8) + RL254;
        int RL289 = RL(RL253, 10);
        int RL290 = RL(RL254 + f1(RL288, RL255, RL289) + this.X[15], 5) + RL256;
        int RL291 = RL(RL255, 10);
        int RL292 = RL(RL256 + f1(RL290, RL288, RL291) + this.X[10], 12) + RL289;
        int RL293 = RL(RL288, 10);
        int RL294 = RL(RL289 + f1(RL292, RL290, RL293) + this.X[4], 9) + RL291;
        int RL295 = RL(RL290, 10);
        int RL296 = RL(RL291 + f1(RL294, RL292, RL295) + this.X[1], 12) + RL293;
        int RL297 = RL(RL292, 10);
        int RL298 = RL(RL293 + f1(RL296, RL294, RL297) + this.X[5], 5) + RL295;
        int RL299 = RL(RL294, 10);
        int RL300 = RL(RL295 + f1(RL298, RL296, RL299) + this.X[8], 14) + RL297;
        int RL301 = RL(RL296, 10);
        int RL302 = RL(RL297 + f1(RL300, RL298, RL301) + this.X[7], 6) + RL299;
        int RL303 = RL(RL298, 10);
        int RL304 = RL(RL299 + f1(RL302, RL300, RL303) + this.X[6], 8) + RL301;
        int RL305 = RL(RL300, 10);
        int RL306 = RL(RL301 + f1(RL304, RL302, RL305) + this.X[2], 13) + RL303;
        int RL307 = RL(RL302, 10);
        int RL308 = RL(RL303 + f1(RL306, RL304, RL307) + this.X[13], 6) + RL305;
        int RL309 = RL(RL304, 10);
        int RL310 = RL(RL305 + f1(RL308, RL306, RL309) + this.X[14], 5) + RL307;
        int RL311 = RL(RL306, 10);
        int RL312 = RL(RL307 + f1(RL310, RL308, RL311) + this.X[0], 15) + RL309;
        int RL313 = RL(RL308, 10);
        int RL314 = RL(RL309 + f1(RL312, RL310, RL313) + this.X[3], 13) + RL311;
        int RL315 = RL(RL310, 10);
        int RL316 = RL(RL311 + f1(RL314, RL312, RL315) + this.X[9], 11) + RL313;
        int RL317 = RL(RL312, 10);
        int RL318 = RL(RL313 + f1(RL316, RL314, RL317) + this.X[11], 11) + RL315;
        this.H1 = this.H2 + RL287 + RL317;
        this.H2 = this.H3 + RL286 + RL315;
        this.H3 = this.H4 + RL284 + RL318;
        this.H4 = this.H0 + RL(((RL282 + f5(RL285, RL283, RL286)) + this.X[13]) - 1454113458, 6) + RL284 + RL316;
        this.H0 = RL(RL314, 10) + RL285 + this.H1;
        this.xOff = 0;
        int i6 = 0;
        while (true) {
            int[] iArr = this.X;
