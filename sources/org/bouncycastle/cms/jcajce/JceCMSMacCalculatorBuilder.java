...
public class JceCMSMacCalculatorBuilder {
    ...
    private class CMSMacCalculator implements MacCalculator {
        ...
        CMSMacCalculator(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws CMSException {
            JceCMSMacCalculatorBuilder.this = r2;
            KeyGenerator createKeyGenerator = r2.helper.createKeyGenerator(aSN1ObjectIdentifier);
            ...
            this.algorithmIdentifier = r2.helper.getAlgorithmIdentifier(aSN1ObjectIdentifier, algorithmParameters == null ? r2.helper.generateParameters(aSN1ObjectIdentifier, this.encKey, secureRandom) : algorithmParameters);
            this.mac = r2.helper.createContentMac(this.encKey, this.algorithmIdentifier);
        }
