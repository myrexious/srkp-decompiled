...
public class CMSAlgorithm {
    ...
    public static final ASN1ObjectIdentifier IDEA_CBC = new ASN1ObjectIdentifier(CMSEnvelopedGenerator.IDEA_CBC).intern();
    public static final ASN1ObjectIdentifier CAST5_CBC = new ASN1ObjectIdentifier(CMSEnvelopedGenerator.CAST5_CBC).intern();
