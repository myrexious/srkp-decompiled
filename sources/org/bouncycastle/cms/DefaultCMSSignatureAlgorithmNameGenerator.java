...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public DefaultCMSSignatureAlgorithmNameGenerator() {
        ...
        addEntries(BCObjectIdentifiers.picnic_with_sha3_512, MessageDigestAlgorithms.SHA3_512, "Picnic");
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        return (!digestAlgName.equals(algorithm.getId()) ? new StringBuilder().append(digestAlgName) : new StringBuilder().append(getDigestAlgName(algorithmIdentifier.getAlgorithm()))).append(JsonPOJOBuilder.DEFAULT_WITH_PREFIX).append(getEncryptionAlgName(algorithm)).toString();
    }
