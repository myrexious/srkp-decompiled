...
public class JceCRMFEncryptorBuilder {
    ...
    private class CRMFOutputEncryptor implements OutputEncryptor {
        ...
        CRMFOutputEncryptor(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i, SecureRandom secureRandom) throws CRMFException {
            JceCRMFEncryptorBuilder.this = r4;
            KeyGenerator createKeyGenerator = r4.helper.createKeyGenerator(aSN1ObjectIdentifier);
            ...
            this.cipher = r4.helper.createCipher(aSN1ObjectIdentifier);
            this.encKey = createKeyGenerator.generateKey();
            AlgorithmParameters generateParameters = r4.helper.generateParameters(aSN1ObjectIdentifier, this.encKey, secureRandom);
            try {
                this.cipher.init(1, this.encKey, generateParameters, secureRandom);
                this.algorithmIdentifier = r4.helper.getAlgorithmIdentifier(aSN1ObjectIdentifier, generateParameters == null ? this.cipher.getParameters() : generateParameters);
