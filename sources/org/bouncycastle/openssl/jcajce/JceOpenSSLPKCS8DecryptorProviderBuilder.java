                ...
                try {
                    if (PEMUtilities.isPKCS5Scheme2(algorithmIdentifier.getAlgorithm())) {
                        ...
                        if (PEMUtilities.isPKCS12(algorithmIdentifier.getAlgorithm())) {
                            ...
                            createCipher = JceOpenSSLPKCS8DecryptorProviderBuilder.this.helper.createCipher(PEMUtilities.getCipherName(algorithmIdentifier.getAlgorithm()));
