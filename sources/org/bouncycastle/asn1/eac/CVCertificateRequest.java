...
public class CVCertificateRequest extends ASN1Object {
    ...
    private CVCertificateRequest(ASN1ApplicationSpecific aSN1ApplicationSpecific) throws IOException {
        ...
        initCertBody(ASN1ApplicationSpecific.getInstance((Object) aSN1Sequence.getObjectAt(0)));
        this.outerSignature = ASN1ApplicationSpecific.getInstance((Object) aSN1Sequence.getObjectAt(aSN1Sequence.size() - 1)).getContents();
    }
