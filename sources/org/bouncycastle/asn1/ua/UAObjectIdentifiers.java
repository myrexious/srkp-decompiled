...
public interface UAObjectIdentifiers {
    ...
    static {
        ...
        sym_id = branch2;
        hmac_gost3411_id = branch2.branch(ExifInterface.GPS_MEASUREMENT_2D);
        ASN1ObjectIdentifier branch3 = branch.branch(ExifInterface.GPS_MEASUREMENT_2D);
        hash_id = branch3;
        gost3411_id = branch3.branch("1");
    }
}
