                ...
                while (i != i2) {
                    ...
                    while (true) {
                        if (i4 >= size) {
                            z = false;
                            break;
                        } else if (!zArr[i4] && aSN1ObjectIdentifier.equals((ASN1Primitive) ((ASN1ObjectIdentifier) x509Name.ordering.elementAt(i4))) && equivalentStrings(str, (String) x509Name.values.elementAt(i4))) {
                            zArr[i4] = true;
                            z = true;
                            break;
                        } else {
