...
public class Utils {
    ...
    public static String keyToString(String str, String str2, AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        stringBuffer.append(str2).append(StringUtils.SPACE).append(str).append(" [").append(generateKeyFingerprint(encoded)).append("]").append(lineSeparator).append("    public data: ").append(Hex.toHexString(encoded)).append(lineSeparator);
