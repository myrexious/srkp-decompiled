    ...
    public byte[] getEncoded() {
        ...
        if (gostParams == null) {
            ...
            if (eCParameterSpec instanceof ECNamedCurveSpec) {
                ...
                gostParams = z ? new GOST3410PublicKeyAlgParameters(oid, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512) : new GOST3410PublicKeyAlgParameters(oid, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256);
            } else {
