...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    public class CertId {
        ...
        CertId(PublicKey publicKey) {
            ...
            this.f48id = r1.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof CertId) {
                return Arrays.areEqual(this.f48id, ((CertId) obj).f48id);
            }
            return false;
        }

        public int hashCode() {
            return Arrays.hashCode(this.f48id);
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:444:0x048d  */
    /* JADX WARN: Removed duplicated region for block: B:448:0x04ac  */
    /* JADX WARN: Removed duplicated region for block: B:481:0x0579  */
    /* JADX WARN: Removed duplicated region for block: B:482:0x0580  */
