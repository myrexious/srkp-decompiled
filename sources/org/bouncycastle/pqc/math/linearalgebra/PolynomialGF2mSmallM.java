...
public class PolynomialGF2mSmallM {
    ...
    private int[] modDivBigDeg(int[] iArr, int[] iArr2, int[] iArr3) {
        int[] normalForm = normalForm(iArr3);
        int[] mod = mod(iArr2, iArr3);
        int[] iArr4 = {0};
        int[] mod2 = mod(iArr, iArr3);
        while (computeDegree(mod) != -1) {
            ...
            int[] normalForm2 = normalForm(mod);
            int[] normalForm3 = normalForm(div[1]);
            int[] add = add(iArr4, modKaratsubaMultiplyBigDeg(div[0], mod2, iArr3));
            iArr4 = normalForm(mod2);
            mod2 = normalForm(add);
            normalForm = normalForm2;
            mod = normalForm3;
    ...
    private int[] modKaratsubaMultiplyBigDeg(int[] iArr, int[] iArr2, int[] iArr3) {
        int[] clone;
        int[] iArr4;
        int i;
        int i2;
        ...
        int[] iArr5 = new int[i3 / 2];
        int i4 = i3 - 1;
        int[] iArr6 = new int[i4];
        int[] iArr7 = new int[i4];
        int[] iArr8 = new int[i4];
        for (int i5 = 0; i5 < length2; i5++) {
            iArr5[i5] = iArr4[i5] * clone[i5];
        }
        int i6 = 1;
        while (true) {
            i = i3 - 2;
            ...
            for (int i7 = 0; i7 < Math.min(length2, i6) && i7 < (i2 = i6 - i7); i7++) {
                int i8 = iArr4[i7];
                int i9 = i2 < iArr4.length ? iArr4[i2] : 0;
                int i10 = clone[i7];
                int i11 = iArr5[i7];
                if (i2 < length2 && i7 < length2) {
                    int i12 = clone[i2];
                    int i13 = iArr5[i2];
                    iArr6[i6] = iArr6[i6] + ((i8 + i9) * (i10 + i12));
                    iArr7[i6] = iArr7[i6] + i11 + i13;
                } else if (i2 >= length2 && i2 < length) {
                    iArr6[i6] = iArr6[i6] + ((i8 + i9) * i10);
                    iArr7[i6] = iArr7[i6] + i11;
                }
            }
            i6++;
        }
        for (int i14 = 0; i14 < i4; i14++) {
            if (i14 == 0) {
                iArr8[i14] = iArr5[i14] % 2;
            } else if (i14 == i) {
                iArr8[i14] = (iArr4[iArr4.length - 1] * clone[clone.length - 1]) % 2;
            } else if (i14 % 2 == 1) {
                iArr8[i14] = (iArr6[i14] - iArr7[i14]) % 2;
            } else {
                iArr8[i14] = ((iArr6[i14] - iArr7[i14]) + iArr5[i14 / 2]) % 2;
            }
        }
        return mod(iArr8, iArr3);
    }
    ...
    public PolynomialGF2mSmallM modInverseBigDeg(PolynomialGF2mSmallM polynomialGF2mSmallM) {
        return new PolynomialGF2mSmallM(this.field, modDivBigDeg(new int[]{1}, this.coefficients, polynomialGF2mSmallM.coefficients));
    }
    ...
    public PolynomialGF2mSmallM modKaratsubaMultiplyBigDeg(PolynomialGF2mSmallM polynomialGF2mSmallM, PolynomialGF2mSmallM polynomialGF2mSmallM2) {
        return new PolynomialGF2mSmallM(this.field, modKaratsubaMultiplyBigDeg(this.coefficients, polynomialGF2mSmallM.coefficients, polynomialGF2mSmallM2.coefficients));
    }
