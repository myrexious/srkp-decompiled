...
public final class BigEndianConversions {
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i6 = i5 + 1;
        int i7 = i6 + 1;
        long j = ((bArr[i] & 255) << 56) | ((bArr[i2] & 255) << 48) | ((bArr[i3] & 255) << 40) | ((bArr[i4] & 255) << 32) | ((255 & bArr[i5]) << 24) | ((bArr[i6] & UByte.MAX_VALUE) << 16);
        return (bArr[i7 + 1] & UByte.MAX_VALUE) | j | ((bArr[i7] & UByte.MAX_VALUE) << 8);
    }
