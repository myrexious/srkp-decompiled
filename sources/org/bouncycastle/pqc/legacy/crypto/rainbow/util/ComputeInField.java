...
public class ComputeInField {
    ...
    */
    ...
    public short[][] inverse(short[][] sArr) {
        try {
            int i = 0;
            this.A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr.length * 2);
    ...
    public short[][] multiplyMatrix(short[][] sArr, short[][] sArr2) throws RuntimeException {
        if (sArr[0].length == sArr2.length) {
            this.A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr2[0].length);
            for (int i = 0; i < sArr.length; i++) {
                for (int i2 = 0; i2 < sArr2.length; i2++) {
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        ...
        try {
            this.A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr.length + 1);
