...
class WotsPlus {
    ...
    public byte[] sign(byte[] bArr, byte[] bArr2, byte[] bArr3, ADRS adrs) {
        ...
        int[] concatenate = Arrays.concatenate(base_w, base_w(Arrays.copyOfRange(intToBigEndian, ((this.engine.WOTS_LEN2 * this.engine.WOTS_LOGW) + 7) / 8, intToBigEndian.length), this.w, this.engine.WOTS_LEN2));
