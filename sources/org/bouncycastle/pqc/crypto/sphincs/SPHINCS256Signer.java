...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddrVar, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        leafaddrVar2.subleaf = 0L;
        while (leafaddrVar2.subleaf < 32) {
            Tree.l_tree(hashFunctions, bArr5, (int) ((leafaddrVar2.subleaf * 32) + FileUtils.ONE_KB), bArr7, (int) (leafaddrVar2.subleaf * 67 * 32), bArr4, 0);
            leafaddrVar2.subleaf++;
        }
        int i3 = 0;
    ...
    byte[] crypto_sign(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2) {
        ...
        for (int i6 = 12; i5 < i6; i6 = 12) {
            ...
            int i8 = horst_sign;
            byte[] bArr14 = bArr11;
            wots.wots_sign(hashFunctions, bArr3, i7, bArr6, bArr7, bArr14);
            int i9 = i8 + 2144;
            compute_authpath_wots(hashFunctions, bArr6, bArr3, i9, leafaddrVar2, bArr13, bArr14, 5);
            horst_sign = i9 + 160;
