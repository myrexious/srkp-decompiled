...
public class FrodoEngine {
    ...
    public FrodoEngine(int i, int i2, int i3, short[] sArr, Xof xof, FrodoMatrixGenerator frodoMatrixGenerator) {
        ...
        int i7 = ((i2 * i) * 8) / 8;
        this.len_ct_bytes = (((i2 * 8) * 8) / 8) + i7;
        int i8 = i7 + 16;
        this.len_pk_bytes = i8;
        this.len_sk_bytes = i5 + i8 + (i * 2 * 8) + i6;
        this.T_chi = sArr;
        this.digest = xof;
    ...
    private byte[] decode(short[] sArr) {
        ...
        for (int i4 = 0; i4 < 8; i4++) {
            ...
            for (int i5 = 0; i5 < 8; i5++) {
                int i6 = this.D;
                j |= (((short) (((sArr[i3] & s2) + (1 << ((i6 - i) - 1))) >> (i6 - i))) & s) << (this.B * i5);
                i3++;
            }
            int i7 = 0;
            while (true) {
    ...
    private short[] matrix_add(short[] sArr, short[] sArr2, int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            for (int i4 = 0; i4 < i2; i4++) {
                int i5 = (i3 * i2) + i4;
                sArr3[i5] = (short) (((sArr[i5] & UShort.MAX_VALUE) + (65535 & sArr2[i5])) % this.q);
            }
        }
        return sArr3;
    }
        ...
        for (int i5 = 0; i5 < i; i5++) {
            for (int i6 = 0; i6 < i4; i6++) {
                for (int i7 = 0; i7 < i2; i7++) {
                    int i8 = (i5 * i4) + i6;
                    sArr3[i8] = (short) (65535 & ((sArr3[i8] & UShort.MAX_VALUE) + ((sArr[(i5 * i2) + i7] & UShort.MAX_VALUE) * (sArr2[(i7 * i4) + i6] & UShort.MAX_VALUE))));
                }
                int i9 = (i5 * i4) + i6;
                sArr3[i9] = (short) (65535 & ((sArr3[i9] & UShort.MAX_VALUE) % this.q));
            }
        }
        return sArr3;
    }
    ...
    private short[] matrix_sub(short[] sArr, short[] sArr2, int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            for (int i4 = 0; i4 < i2; i4++) {
                int i5 = (i3 * i2) + i4;
                sArr3[i5] = (short) (((sArr[i5] - sArr2[i5]) & 65535) % this.q);
            }
        }
        return sArr3;
    }
    ...
    private short[] unpack(byte[] bArr, int i, int i2) {
        ...
        while (s < i3 && (s2 < bArr.length || (s2 == bArr.length && b > 0))) {
            ...
            while (true) {
                ...
                sArr[s] = (short) (((sArr[s] & UShort.MAX_VALUE) + ((((byte) ((((b2 & UByte.MAX_VALUE) >>> ((b & UByte.MAX_VALUE) - min)) & (s3 & UShort.MAX_VALUE)) & 255)) & UByte.MAX_VALUE) << ((this.D - (b3 & UByte.MAX_VALUE)) - min))) & 65535);
                b3 = (byte) (b3 + min);
                byte b4 = (byte) (b - min);
    ...
    public void kem_dec(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        int i = (((this.n * 8) * this.D) / 8) + 0;
        byte[] copyOfRange = Arrays.copyOfRange(bArr2, 0, i);
        byte[] copyOfRange2 = Arrays.copyOfRange(bArr2, i, ((this.D * 64) / 8) + i);
        ...
        int i15 = this.n;
        short[] matrix_add = matrix_add(matrix_mul(sample_matrix, 8, i15, genMatrix, i15, i15), sample_matrix2, 8, this.n);
        short[] sample_matrix3 = sample_matrix(sArr2, this.n * 16, 8, 8);
    ...
    public void kem_keypair(byte[] bArr, byte[] bArr2, SecureRandom secureRandom) {
        ...
        this.digest.update(BuiltinOptions.NonMaxSuppressionV4Options);
        this.digest.update(copyOfRange2, 0, copyOfRange2.length);
