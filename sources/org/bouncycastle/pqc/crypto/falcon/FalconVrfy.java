...
class FalconVrfy {
    ...
    public int complete_private(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, int i5, short[] sArr, int i6) {
        ...
        for (int i11 = 0; i11 < i7; i11++) {
            ...
            int i12 = i6 + i11;
            sArr[i12] = (short) mq_div_12289(sArr[i12], s);
        }
        mq_iNTT(sArr, i6, i5);
        for (int i13 = 0; i13 < i7; i13++) {
            int i14 = sArr[i6 + i13] & UShort.MAX_VALUE;
            int i15 = i14 - ((~(-((i14 - 6144) >>> 31))) & 12289);
            if (i15 < -127 || i15 > 127) {
                return 0;
            }
            bArr[i + i13] = (byte) i15;
    ...
    public int compute_public(short[] sArr, int i, byte[] bArr, int i2, byte[] bArr2, int i3, int i4, short[] sArr2, int i5) {
        int i6 = 1 << i4;
        for (int i7 = 0; i7 < i6; i7++) {
            sArr2[i5 + i7] = (short) mq_conv_small(bArr[i2 + i7]);
            sArr[i + i7] = (short) mq_conv_small(bArr2[i3 + i7]);
        }
        mq_NTT(sArr, i, i4);
        mq_NTT(sArr2, i5, i4);
        for (int i8 = 0; i8 < i6; i8++) {
            ...
            int i9 = i + i8;
            sArr[i9] = (short) mq_div_12289(sArr[i9], s);
        }
        mq_iNTT(sArr, i, i4);
        return 1;
    }

    int count_nttzero(short[] sArr, int i, int i2, short[] sArr2, int i3) {
        int i4 = 1 << i2;
        for (int i5 = 0; i5 < i4; i5++) {
            short s = sArr[i + i5];
            sArr2[i3 + i5] = (short) (s + ((-(s >>> 31)) & 12289));
        }
        mq_NTT(sArr2, i3, i2);
        int i6 = 0;
        for (int i7 = 0; i7 < i4; i7++) {
            i6 += ((sArr2[i3 + i7] & UShort.MAX_VALUE) - 1) >>> 31;
        }
        return i6;
    }

    int is_invertible(short[] sArr, int i, int i2, short[] sArr2, int i3) {
        int i4 = 1 << i2;
        for (int i5 = 0; i5 < i4; i5++) {
            short s = sArr[i + i5];
            sArr2[i3 + i5] = (short) (s + ((-(s >>> 31)) & 12289));
        ...
        int i6 = 0;
        for (int i7 = 0; i7 < i4; i7++) {
            i6 |= (sArr2[i3 + i7] & UShort.MAX_VALUE) - 1;
        }
        return 1 - (i6 >>> 31);
    }

    void mq_NTT(short[] sArr, int i, int i2) {
        int i3 = 1;
        int i4 = 1 << i2;
        int i5 = i4;
        while (i3 < i4) {
            ...
            int i8 = 0;
            while (i7 < i3) {
                short s = this.GMb[i3 + i7];
                int i9 = i8 + i6;
                for (int i10 = i8; i10 < i9; i10++) {
                    int i11 = i + i10;
                    int i12 = sArr[i11] & UShort.MAX_VALUE;
                    int i13 = i11 + i6;
                    int mq_montymul = mq_montymul(sArr[i13], s);
                    sArr[i11] = (short) mq_add(i12, mq_montymul);
                    sArr[i13] = (short) mq_sub(i12, mq_montymul);
                }
                i7++;
                i8 += i5;
            }
    ...
    int mq_add(int i, int i2) {
        int i3 = (i + i2) - 12289;
        return i3 + ((-(i3 >>> 31)) & 12289);
    }

    int mq_conv_small(int i) {
        return i + ((-(i >>> 31)) & 12289);
    }

    int mq_div_12289(int i, int i2) {
        int mq_montymul = mq_montymul(i2, 10952);
        int mq_montysqr = mq_montysqr(mq_montymul);
        int mq_montymul2 = mq_montymul(mq_montysqr, mq_montymul);
        int mq_montysqr2 = mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montymul(mq_montymul2, mq_montysqr))))));
        int mq_montymul3 = mq_montymul(mq_montysqr2, mq_montymul2);
        int mq_montymul4 = mq_montymul(mq_montymul3, mq_montysqr2);
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul4)), mq_montymul3))), mq_montymul4)), mq_montymul), i);
    }

    void mq_iNTT(short[] sArr, int i, int i2) {
        int i3;
        int i4 = 1 << i2;
        int i5 = 1;
        int i6 = i4;
        while (true) {
            ...
            while (i3 < i6) {
                int i9 = i8 + i5;
                short s = this.iGMb[i6 + i3];
                for (int i10 = i8; i10 < i9; i10++) {
                    int i11 = i + i10;
                    int i12 = sArr[i11] & UShort.MAX_VALUE;
                    int i13 = i11 + i5;
                    int i14 = 65535 & sArr[i13];
                    sArr[i11] = (short) mq_add(i12, i14);
                    sArr[i13] = (short) mq_montymul(mq_sub(i12, i14), s);
                }
                i3++;
                i8 += i7;
            }
        ...
        int i15 = 4091;
        for (int i16 = i4; i16 > 1; i16 >>= 1) {
            i15 = mq_rshift1(i15);
        }
        while (i3 < i4) {
            int i17 = i + i3;
            sArr[i17] = (short) mq_montymul(sArr[i17], i15);
            i3++;
        }
    }

    int mq_montymul(int i, int i2) {
        int i3 = i * i2;
        int i4 = ((i3 + (((i3 * 12287) & 65535) * 12289)) >>> 16) - 12289;
        return i4 + ((-(i4 >>> 31)) & 12289);
    }

    int mq_montysqr(int i) {
        return mq_montymul(i, i);
    }

    void mq_poly_montymul_ntt(short[] sArr, int i, short[] sArr2, int i2, int i3) {
        int i4 = 1 << i3;
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = i + i5;
            sArr[i6] = (short) mq_montymul(sArr[i6], sArr2[i2 + i5]);
        }
    }

    void mq_poly_sub(short[] sArr, int i, short[] sArr2, int i2, int i3) {
        int i4 = 1 << i3;
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = i + i5;
            sArr[i6] = (short) mq_sub(sArr[i6], sArr2[i2 + i5]);
        }
    }

    void mq_poly_tomonty(short[] sArr, int i, int i2) {
        int i3 = 1 << i2;
        for (int i4 = 0; i4 < i3; i4++) {
            int i5 = i + i4;
            sArr[i5] = (short) mq_montymul(sArr[i5], 10952);
        }
    }

    int mq_rshift1(int i) {
        return (i + ((-(i & 1)) & 12289)) >>> 1;
    }

    int mq_sub(int i, int i2) {
        int i3 = i - i2;
        return i3 + ((-(i3 >>> 31)) & 12289);
    }

    public void to_ntt_monty(short[] sArr, int i, int i2) {
        mq_NTT(sArr, i, i2);
        mq_poly_tomonty(sArr, i, i2);
    }

    public int verify_raw(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, int i4, short[] sArr4, int i5) {
        int i6 = 1 << i4;
        for (int i7 = 0; i7 < i6; i7++) {
            short s = sArr2[i2 + i7];
            sArr4[i5 + i7] = (short) (s + ((-(s >>> 31)) & 12289));
        }
        mq_NTT(sArr4, i5, i4);
        mq_poly_montymul_ntt(sArr4, i5, sArr3, i3, i4);
        mq_iNTT(sArr4, i5, i4);
        mq_poly_sub(sArr4, i5, sArr, i, i4);
        for (int i8 = 0; i8 < i6; i8++) {
            int i9 = i5 + i8;
            int i10 = sArr4[i9] & UShort.MAX_VALUE;
            sArr4[i9] = (short) (i10 - ((-((6144 - i10) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, i5, sArr2, i2, i4);
    }

    int verify_recover(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, short[] sArr4, int i4, int i5, short[] sArr5, int i6) {
        int i7 = 1 << i5;
        for (int i8 = 0; i8 < i7; i8++) {
            short s = sArr4[i4 + i8];
            sArr5[i6 + i8] = (short) (s + ((-(s >> 31)) & 12289));
            short s2 = sArr3[i3 + i8];
            sArr[i + i8] = (short) mq_sub(sArr2[i2 + i8], 65535 & (s2 + ((-(s2 >>> 31)) & 12289)));
        }
        mq_NTT(sArr5, i6, i5);
        mq_NTT(sArr5, i, i5);
        int i9 = 0;
        for (int i10 = 0; i10 < i7; i10++) {
            short s3 = sArr5[i6 + i10];
            i9 |= (s3 & UShort.MAX_VALUE) - 1;
            int i11 = i + i10;
            sArr[i11] = (short) mq_div_12289(sArr[i11] & UShort.MAX_VALUE, s3 & UShort.MAX_VALUE);
        }
        mq_iNTT(sArr, i, i5);
        return ((-this.common.is_short(sArr3, i3, sArr4, i4, i5)) & (~i9)) >>> 31;
    }
}
