...
class SIKECipherSpi extends CipherSpi {
    ...
    /* loaded from: classes2.dex */
    public static class Base extends SIKECipherSpi {
        public Base() throws NoSuchAlgorithmException {
            super("SIKE");
        }
    }

    SIKECipherSpi(String str) throws NoSuchAlgorithmException {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (i == 3) {
            ...
            this.wrapKey = (BCSIKEPublicKey) key;
            this.kemGen = new SIKEKEMGenerator(secureRandom);
        } else if (i != 4) {
            ...
            this.unwrapKey = (BCSIKEPrivateKey) key;
        }
    }
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws InvalidKeyException, NoSuchAlgorithmException {
        if (i == 3) {
            try {
                SIKEKEMExtractor sIKEKEMExtractor = new SIKEKEMExtractor(this.unwrapKey.getKeyParams());
                byte[] extractSecret = sIKEKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, sIKEKEMExtractor.getEncapsulationLength()));
                ...
                byte[] copyOfRange = Arrays.copyOfRange(bArr, sIKEKEMExtractor.getEncapsulationLength(), bArr.length);
