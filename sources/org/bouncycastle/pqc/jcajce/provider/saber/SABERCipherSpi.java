...
class SABERCipherSpi extends CipherSpi {
    ...
    SABERCipherSpi(String str) throws NoSuchAlgorithmException {
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws InvalidKeyException, NoSuchAlgorithmException {
        if (i == 3) {
            try {
                ...
                byte[] extractSecret = sABERKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, sABERKEMExtractor.getEncapsulationLength()));
                ...
                byte[] copyOfRange = Arrays.copyOfRange(bArr, sABERKEMExtractor.getEncapsulationLength(), bArr.length);
