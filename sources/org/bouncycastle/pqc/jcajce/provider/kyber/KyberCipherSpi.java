...
class KyberCipherSpi extends CipherSpi {
    ...
    KyberCipherSpi(String str) throws NoSuchAlgorithmException {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (i == 3) {
            ...
            this.kemGen = new KyberKEMGenerator(secureRandom);
        } else if (i != 4) {
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws InvalidKeyException, NoSuchAlgorithmException {
        if (i == 3) {
            try {
                ...
                byte[] extractSecret = kyberKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, kyberKEMExtractor.getEncapsulationLength()));
