...
public class DefaultAlgorithmNameFinder implements AlgorithmNameFinder {
    ...
    static {
        ...
        hashMap.put(BCObjectIdentifiers.falcon_512, "FALCON");
        hashMap.put(BCObjectIdentifiers.falcon_1024, "FALCON");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha_256, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha_512, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_256, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka, "SPHINCS+");
        ...
        hashMap.put(NISTObjectIdentifiers.id_sha3_224, MessageDigestAlgorithms.SHA3_224);
        hashMap.put(NISTObjectIdentifiers.id_sha3_256, "SHA3-256");
        hashMap.put(NISTObjectIdentifiers.id_sha3_384, MessageDigestAlgorithms.SHA3_384);
        hashMap.put(NISTObjectIdentifiers.id_sha3_512, MessageDigestAlgorithms.SHA3_512);
        ...
        hashMap.put(PKCSObjectIdentifiers.md5, MessageDigestAlgorithms.MD5);
