...
public final class SpecialOccurrence {
    ...
    public static /* synthetic */ SpecialOccurrence copy$default(SpecialOccurrence specialOccurrence, String str, boolean z, int i, boolean z2, boolean z3, String str2, String str3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = specialOccurrence.kodeTps;
        }
        if ((i2 & 2) != 0) {
            z = specialOccurrence.isPdf;
        }
        boolean z4 = z;
        if ((i2 & 4) != 0) {
            i = specialOccurrence.uploadPdfStatus;
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            z2 = specialOccurrence.isUploadedPdf;
        }
        boolean z5 = z2;
        if ((i2 & 16) != 0) {
            z3 = specialOccurrence.isUploadedPdfOffline;
        }
        boolean z6 = z3;
        if ((i2 & 32) != 0) {
            str2 = specialOccurrence.pdfFilePath;
        }
        String str4 = str2;
        if ((i2 & 64) != 0) {
            str3 = specialOccurrence.pdfFileHash;
        }
        return specialOccurrence.copy(str, z4, i3, z5, z6, str4, str3);
    }
    ...
    public final SpecialOccurrence copy(String kodeTps, boolean z, int i, boolean z2, boolean z3, String str, String str2) {
        Intrinsics.checkNotNullParameter(kodeTps, "kodeTps");
        return new SpecialOccurrence(kodeTps, z, i, z2, z3, str, str2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SpecialOccurrence) {
            SpecialOccurrence specialOccurrence = (SpecialOccurrence) obj;
            return Intrinsics.areEqual(this.kodeTps, specialOccurrence.kodeTps) && this.isPdf == specialOccurrence.isPdf && this.uploadPdfStatus == specialOccurrence.uploadPdfStatus && this.isUploadedPdf == specialOccurrence.isUploadedPdf && this.isUploadedPdfOffline == specialOccurrence.isUploadedPdfOffline && Intrinsics.areEqual(this.pdfFilePath, specialOccurrence.pdfFilePath) && Intrinsics.areEqual(this.pdfFileHash, specialOccurrence.pdfFileHash);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "SpecialOccurrence(kodeTps=" + str + ", isPdf=" + z + ", uploadPdfStatus=" + i + ", isUploadedPdf=" + z2 + ", isUploadedPdfOffline=" + z3 + ", pdfFilePath=" + str2 + ", pdfFileHash=" + this.pdfFileHash + ")";
    }

    public SpecialOccurrence(String kodeTps, boolean z, int i, boolean z2, boolean z3, String str, String str2) {
        Intrinsics.checkNotNullParameter(kodeTps, "kodeTps");
    ...
    public /* synthetic */ SpecialOccurrence(String str, boolean z, int i, boolean z2, boolean z3, String str2, String str3, int i2, DefaultConstructorMarker defaultConstructorMarker) {
