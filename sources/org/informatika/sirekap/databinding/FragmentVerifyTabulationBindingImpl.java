...
public class FragmentVerifyTabulationBindingImpl extends FragmentVerifyTabulationBinding {
    ...
    public FragmentVerifyTabulationBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 29, sIncludes, sViewsWithIds));
    }

    private FragmentVerifyTabulationBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        if (16 == variableId) {
            ...
            setViewModel((VerifyTabulationViewModel) variable);
        }
        return true;
    }

    @Override // org.informatika.sirekap.databinding.FragmentVerifyTabulationBinding
    ...
    @Override // org.informatika.sirekap.databinding.FragmentVerifyTabulationBinding
    public void setViewModel(VerifyTabulationViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 11:
                return onChangeViewModelFormC1Tabulation((LiveData) object, fieldId);
            case 12:
    ...
    private boolean onChangeViewModelFormC1Tabulation(LiveData<FormC1TabulationComplete> ViewModelFormC1Tabulation, int fieldId) {
        if (fieldId == 0) {
            synchronized (this) {
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.informatika.sirekap.databinding.FragmentVerifyTabulationBindingImpl.executeBindings():void");
    }
}
