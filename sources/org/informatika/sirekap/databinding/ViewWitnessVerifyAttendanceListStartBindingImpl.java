...
public class ViewWitnessVerifyAttendanceListStartBindingImpl extends ViewWitnessVerifyAttendanceListStartBinding {
    ...
    public ViewWitnessVerifyAttendanceListStartBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private ViewWitnessVerifyAttendanceListStartBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // org.informatika.sirekap.databinding.ViewWitnessVerifyAttendanceListStartBinding
    ...
    protected void executeBindings() {
        ...
        String str = null;
        if (i != 0) {
            LiveData<Boolean> isFirstCheck = verifyWitnessAttendanceListViewModel != null ? verifyWitnessAttendanceListViewModel.isFirstCheck() : null;
            ...
            boolean z3 = !z2;
            str = this.subtitleStartVerification.getResources().getString(z2 ? R.string.verify_attendees_start_subtitle : R.string.verify_attendees_start_subtitle_unfinished);
