...
/* compiled from: VerifyTabulationFragmentArgs.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u000f\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\b\u0018\u0000 \u001e2\u00020\u0001:\u0001\u001eB%\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0003\u0012\u0006\u0010\u0007\u001a\u00020\u0003¢\u0006\u0002\u0010\bJ\t\u0010\u000f\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0010\u001a\u00020\u0005HÆ\u0003J\t\u0010\u0011\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0012\u001a\u00020\u0003HÆ\u0003J1\u0010\u0013\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00032\b\b\u0002\u0010\u0007\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u0014\u001a\u00020\u00152\b\u0010\u0016\u001a\u0004\u0018\u00010\u0017HÖ\u0003J\t\u0010\u0018\u001a\u00020\u0005HÖ\u0001J\u0006\u0010\u0019\u001a\u00020\u001aJ\u0006\u0010\u001b\u001a\u00020\u001cJ\t\u0010\u001d\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0006\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0007\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\n¨\u0006\u001f"}, d2 = {"Lorg/informatika/sirekap/ui/verify/tabulation/VerifyTabulationFragmentArgs;", "Landroidx/navigation/NavArgs;", "idImage", "", "electionPageKind", "", "electionPageId", "electionPemilihan", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", "getElectionPageId", "()Ljava/lang/String;", "getElectionPageKind", "()I", "getElectionPemilihan", "getIdImage", "component1", "component2", "component3", "component4", "copy", "equals", "", "other", "", "hashCode", "toBundle", "Landroid/os/Bundle;", "toSavedStateHandle", "Landroidx/lifecycle/SavedStateHandle;", "toString", "Companion", "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class VerifyTabulationFragmentArgs implements NavArgs {
    ...
    public static /* synthetic */ VerifyTabulationFragmentArgs copy$default(VerifyTabulationFragmentArgs verifyTabulationFragmentArgs, String str, int i, String str2, String str3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = verifyTabulationFragmentArgs.idImage;
        }
        if ((i2 & 2) != 0) {
            i = verifyTabulationFragmentArgs.electionPageKind;
        }
        if ((i2 & 4) != 0) {
            str2 = verifyTabulationFragmentArgs.electionPageId;
        }
        if ((i2 & 8) != 0) {
            str3 = verifyTabulationFragmentArgs.electionPemilihan;
        }
        return verifyTabulationFragmentArgs.copy(str, i, str2, str3);
    }

    @JvmStatic
    public static final VerifyTabulationFragmentArgs fromBundle(Bundle bundle) {
        return Companion.fromBundle(bundle);
    }

    @JvmStatic
    public static final VerifyTabulationFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
    ...
    public final VerifyTabulationFragmentArgs copy(String idImage, int i, String electionPageId, String electionPemilihan) {
        ...
        return new VerifyTabulationFragmentArgs(idImage, i, electionPageId, electionPemilihan);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifyTabulationFragmentArgs) {
            VerifyTabulationFragmentArgs verifyTabulationFragmentArgs = (VerifyTabulationFragmentArgs) obj;
            return Intrinsics.areEqual(this.idImage, verifyTabulationFragmentArgs.idImage) && this.electionPageKind == verifyTabulationFragmentArgs.electionPageKind && Intrinsics.areEqual(this.electionPageId, verifyTabulationFragmentArgs.electionPageId) && Intrinsics.areEqual(this.electionPemilihan, verifyTabulationFragmentArgs.electionPemilihan);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "VerifyTabulationFragmentArgs(idImage=" + str + ", electionPageKind=" + i + ", electionPageId=" + str2 + ", electionPemilihan=" + this.electionPemilihan + ")";
    }

    public VerifyTabulationFragmentArgs(String idImage, int i, String electionPageId, String electionPemilihan) {
        Intrinsics.checkNotNullParameter(idImage, "idImage");
        Intrinsics.checkNotNullParameter(electionPageId, "electionPageId");
        Intrinsics.checkNotNullParameter(electionPemilihan, "electionPemilihan");
    ...
    /* compiled from: VerifyTabulationFragmentArgs.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\tH\u0007¨\u0006\n"}, d2 = {"Lorg/informatika/sirekap/ui/verify/tabulation/VerifyTabulationFragmentArgs$Companion;", "", "()V", "fromBundle", "Lorg/informatika/sirekap/ui/verify/tabulation/VerifyTabulationFragmentArgs;", "bundle", "Landroid/os/Bundle;", "fromSavedStateHandle", "savedStateHandle", "Landroidx/lifecycle/SavedStateHandle;", "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes4.dex */
    public static final class Companion {
        ...
        @JvmStatic
        public final VerifyTabulationFragmentArgs fromBundle(Bundle bundle) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            bundle.setClassLoader(VerifyTabulationFragmentArgs.class.getClassLoader());
                ...
                if (bundle.containsKey("electionPageKind")) {
                    ...
                    if (bundle.containsKey("electionPageId")) {
                        ...
                        if (bundle.containsKey("electionPemilihan")) {
                            ...
                            return new VerifyTabulationFragmentArgs(string, i, string2, string3);
                        }
        ...
        @JvmStatic
        public final VerifyTabulationFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
                ...
                if (savedStateHandle.contains("electionPageKind")) {
                    ...
                    if (savedStateHandle.contains("electionPageId")) {
                        ...
                        if (savedStateHandle.contains("electionPemilihan")) {
                            ...
                            return new VerifyTabulationFragmentArgs(str, num.intValue(), str2, str3);
                        }
                        throw new IllegalArgumentException("Required argument \"electionPemilihan\" is missing and does not have an android:defaultValue");
                    }
                    throw new IllegalArgumentException("Required argument \"electionPageId\" is missing and does not have an android:defaultValue");
