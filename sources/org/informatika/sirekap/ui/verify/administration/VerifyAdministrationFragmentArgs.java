...
/* compiled from: VerifyAdministrationFragmentArgs.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\f\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\b\u0018\u0000 \u001b2\u00020\u0001:\u0001\u001bB\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0003¢\u0006\u0002\u0010\u0007J\t\u0010\r\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000e\u001a\u00020\u0005HÆ\u0003J\t\u0010\u000f\u001a\u00020\u0003HÆ\u0003J'\u0010\u0010\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0014HÖ\u0003J\t\u0010\u0015\u001a\u00020\u0005HÖ\u0001J\u0006\u0010\u0016\u001a\u00020\u0017J\u0006\u0010\u0018\u001a\u00020\u0019J\t\u0010\u001a\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0006\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\t¨\u0006\u001c"}, d2 = {"Lorg/informatika/sirekap/ui/verify/administration/VerifyAdministrationFragmentArgs;", "Landroidx/navigation/NavArgs;", "idImage", "", "electionPageKind", "", "electionPageId", "(Ljava/lang/String;ILjava/lang/String;)V", "getElectionPageId", "()Ljava/lang/String;", "getElectionPageKind", "()I", "getIdImage", "component1", "component2", "component3", "copy", "equals", "", "other", "", "hashCode", "toBundle", "Landroid/os/Bundle;", "toSavedStateHandle", "Landroidx/lifecycle/SavedStateHandle;", "toString", "Companion", "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class VerifyAdministrationFragmentArgs implements NavArgs {
    public static final Companion Companion = new Companion(null);
    private final String electionPageId;
    private final int electionPageKind;
    private final String idImage;

    public static /* synthetic */ VerifyAdministrationFragmentArgs copy$default(VerifyAdministrationFragmentArgs verifyAdministrationFragmentArgs, String str, int i, String str2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = verifyAdministrationFragmentArgs.idImage;
        }
        if ((i2 & 2) != 0) {
            i = verifyAdministrationFragmentArgs.electionPageKind;
        }
        if ((i2 & 4) != 0) {
            str2 = verifyAdministrationFragmentArgs.electionPageId;
        }
        return verifyAdministrationFragmentArgs.copy(str, i, str2);
    }

    @JvmStatic
    public static final VerifyAdministrationFragmentArgs fromBundle(Bundle bundle) {
        return Companion.fromBundle(bundle);
    }

    @JvmStatic
    public static final VerifyAdministrationFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
    ...
    public final VerifyAdministrationFragmentArgs copy(String idImage, int i, String electionPageId) {
        Intrinsics.checkNotNullParameter(idImage, "idImage");
        Intrinsics.checkNotNullParameter(electionPageId, "electionPageId");
        return new VerifyAdministrationFragmentArgs(idImage, i, electionPageId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifyAdministrationFragmentArgs) {
            VerifyAdministrationFragmentArgs verifyAdministrationFragmentArgs = (VerifyAdministrationFragmentArgs) obj;
            return Intrinsics.areEqual(this.idImage, verifyAdministrationFragmentArgs.idImage) && this.electionPageKind == verifyAdministrationFragmentArgs.electionPageKind && Intrinsics.areEqual(this.electionPageId, verifyAdministrationFragmentArgs.electionPageId);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "VerifyAdministrationFragmentArgs(idImage=" + str + ", electionPageKind=" + i + ", electionPageId=" + this.electionPageId + ")";
    }

    public VerifyAdministrationFragmentArgs(String idImage, int i, String electionPageId) {
        Intrinsics.checkNotNullParameter(idImage, "idImage");
        Intrinsics.checkNotNullParameter(electionPageId, "electionPageId");
    ...
    /* compiled from: VerifyAdministrationFragmentArgs.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\tH\u0007¨\u0006\n"}, d2 = {"Lorg/informatika/sirekap/ui/verify/administration/VerifyAdministrationFragmentArgs$Companion;", "", "()V", "fromBundle", "Lorg/informatika/sirekap/ui/verify/administration/VerifyAdministrationFragmentArgs;", "bundle", "Landroid/os/Bundle;", "fromSavedStateHandle", "savedStateHandle", "Landroidx/lifecycle/SavedStateHandle;", "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes4.dex */
    public static final class Companion {
        ...
        @JvmStatic
        public final VerifyAdministrationFragmentArgs fromBundle(Bundle bundle) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            bundle.setClassLoader(VerifyAdministrationFragmentArgs.class.getClassLoader());
            if (bundle.containsKey("idImage")) {
                ...
                if (bundle.containsKey("electionPageKind")) {
                    ...
                    if (bundle.containsKey("electionPageId")) {
                        ...
                        return new VerifyAdministrationFragmentArgs(string, i, string2);
                    }
        ...
        @JvmStatic
        public final VerifyAdministrationFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
            ...
            if (savedStateHandle.contains("idImage")) {
                ...
                if (savedStateHandle.contains("electionPageKind")) {
                    ...
                    if (savedStateHandle.contains("electionPageId")) {
                        ...
                        return new VerifyAdministrationFragmentArgs(str, num.intValue(), str2);
                    }
                    throw new IllegalArgumentException("Required argument \"electionPageId\" is missing and does not have an android:defaultValue");
                }
                throw new IllegalArgumentException("Required argument \"electionPageKind\" is missing and does not have an android:defaultValue");
