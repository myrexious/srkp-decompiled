...
public final class CHSalinanDPRDKabkoGenerator extends PdfGenerator {
    ...
    static /* synthetic */ void writeValueInt$default(CHSalinanDPRDKabkoGenerator cHSalinanDPRDKabkoGenerator, PDPageContentStream pDPageContentStream, Pair pair, int i, float f, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            f = 24.0f;
        }
        cHSalinanDPRDKabkoGenerator.writeValueInt(pDPageContentStream, pair, i, f);
    }
