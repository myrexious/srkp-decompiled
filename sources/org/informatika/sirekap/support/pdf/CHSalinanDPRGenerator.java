...
public final class CHSalinanDPRGenerator extends PdfGenerator {
    ...
    public CHSalinanDPRGenerator(Context context, CHCandidateData data) {
        ...
        Float valueOf11 = Float.valueOf(701.0f);
    ...
    public void generate(File file) {
        ...
        InputStream open = getContext().getAssets().open("pdf/12_FORMAT_DPR.pdf");
        Intrinsics.checkNotNullExpressionValue(open, "context.assets.open(\"pdf/12_FORMAT_DPR.pdf\")");
    ...
    private final void partyWritter(PDPageContentStream pDPageContentStream, Pair<Float, Float> pair, List<Integer> list) {
        ...
        for (Object obj : list) {
            ...
            writeValueInt$default(this, pDPageContentStream, new Pair(pair.getFirst(), Float.valueOf(pair.getSecond().floatValue() - (i * 20.25f))), ((Number) obj).intValue(), 0.0f, 8, null);
            i = i2;
        }
        ...
        Pair<Float, Float> pair2 = new Pair<>(Float.valueOf(pair.getFirst().floatValue() - 170), Float.valueOf((pair.getSecond().floatValue() - (list.size() * 20.25f)) + 3));
    ...
    static /* synthetic */ void writeValueInt$default(CHSalinanDPRGenerator cHSalinanDPRGenerator, PDPageContentStream pDPageContentStream, Pair pair, int i, float f, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            f = 24.0f;
        }
        cHSalinanDPRGenerator.writeValueInt(pDPageContentStream, pair, i, f);
    }
