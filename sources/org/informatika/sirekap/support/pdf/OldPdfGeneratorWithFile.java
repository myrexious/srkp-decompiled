...
/* compiled from: OldPdfGeneratorWithFile.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001BE\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0016\u0010\u0004\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007\u0012\u0016\u0010\b\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007\u0012\u0006\u0010\t\u001a\u00020\n¢\u0006\u0002\u0010\u000bJ\u0010\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0017R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u001e\u0010\u0004\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u001e\u0010\b\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lorg/informatika/sirekap/support/pdf/OldPdfGeneratorWithFile;", "Lorg/informatika/sirekap/support/pdf/PdfGenerator;", "context", "Landroid/content/Context;", "listImage", "Ljava/util/ArrayList;", "", "Lkotlin/collections/ArrayList;", "listSaksi", "keystoreManager", "Lorg/informatika/sirekap/support/security/keystore/KeystoreManager;", "(Landroid/content/Context;Ljava/util/ArrayList;Ljava/util/ArrayList;Lorg/informatika/sirekap/support/security/keystore/KeystoreManager;)V", "generate", "", StringLookupFactory.KEY_FILE, "Ljava/io/File;", "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes2.dex */
public final class OldPdfGeneratorWithFile extends PdfGenerator {
    private final KeystoreManager keystoreManager;
    private final ArrayList<String> listImage;
    private final ArrayList<String> listSaksi;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OldPdfGeneratorWithFile(Context context, ArrayList<String> listImage, ArrayList<String> listSaksi, KeystoreManager keystoreManager) {
        super(context);
    ...
    public void generate(File file) {
        ...
        PDPageContentStream pDPageContentStream2 = new PDPageContentStream(load, pDPage2);
        ...
        while (it3.hasNext()) {
            ...
            load.addPage(pDPage3);
            PDPageContentStream pDPageContentStream3 = new PDPageContentStream(load, pDPage3);
            ...
            pDPageContentStream3.drawImage(new PDImageXObject(load, new ByteArrayInputStream(byteArrayOutputStream2.toByteArray()), COSName.DCT_DECODE, decodeFile2.getWidth(), decodeFile2.getHeight(), 8, PDDeviceRGB.INSTANCE), PDRectangle.A4.getWidth() * 0.1f, PDRectangle.A4.getHeight() * 0.1f, PDRectangle.A4.getWidth() * 0.8f, PDRectangle.A4.getHeight() * 0.8f);
            pDPageContentStream3.close();
            decodeFile2.recycle();
            i = i;
        }
        PDPage pDPage4 = new PDPage(new PDRectangle(PDRectangle.A4.getWidth(), PDRectangle.A4.getHeight()));
        load.addPage(pDPage4);
        Log.d("OldPdfGenerator", "PDF Security Info");
        PDPageContentStream pDPageContentStream4 = new PDPageContentStream(load, pDPage4);
