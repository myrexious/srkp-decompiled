...
@Metadata(d1 = {"\u0000/\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001J\u0014\u0010\u0004\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00060\u0005H\u0014J\u000e\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\u0005H\u0014J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0003H\u0014J\u0012\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u0002H\u0014¨\u0006\u000e"}, d2 = {"org/informatika/sirekap/repository/DefaultElectionRepository$updateSpecialOccurrencePagePhoto$1", "Lorg/informatika/sirekap/support/NetworkBoundResource;", "Lorg/informatika/sirekap/model/SpecialOccurrencePage;", "Lorg/informatika/sirekap/api/response/EmptyApiResponse;", "createCall", "Landroidx/lifecycle/LiveData;", "Lorg/informatika/sirekap/api/ApiResponse;", "loadFromDb", "saveCallResult", "", "item", "shouldFetch", "", Constants.ScionAnalytics.MessageType.DATA_MESSAGE, "app_productionRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes2.dex */
public final class DefaultElectionRepository$updateSpecialOccurrencePagePhoto$1 extends NetworkBoundResource<SpecialOccurrencePage, EmptyApiResponse> {
    ...
    public DefaultElectionRepository$updateSpecialOccurrencePagePhoto$1(DefaultElectionRepository defaultElectionRepository, long j, String str, String str2, String str3, AppExecutors appExecutors) {
        super(appExecutors);
    ...
    public void saveCallResult(EmptyApiResponse item) {
        ...
        appDatabase.runInTransaction(new Runnable() { // from class: org.informatika.sirekap.repository.DefaultElectionRepository$updateSpecialOccurrencePagePhoto$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                DefaultElectionRepository$updateSpecialOccurrencePagePhoto$1.saveCallResult$lambda$0(DefaultElectionRepository.this, j, str, str2, str3);
            }
        });
    }

    public static final void saveCallResult$lambda$0(DefaultElectionRepository this$0, long j, String photoPath, String croppedPhotoPath, String hashDocumentCropped) {
        AppDatabase appDatabase;
        ...
        appDatabase.specialOccurrencePageDao().finishPhoto(j, photoPath, croppedPhotoPath, hashDocumentCropped);
    }
