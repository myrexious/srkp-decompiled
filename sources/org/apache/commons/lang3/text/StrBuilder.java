...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder appendAll(Iterable<?> iterable) {
        if (iterable != null) {
            iterable.forEach(new StrBuilder$$ExternalSyntheticLambda0(this));
        }
        return this;
    }
    ...
    public StrBuilder appendAll(Iterator<?> it) {
        if (it != null) {
            it.forEachRemaining(new StrBuilder$$ExternalSyntheticLambda0(this));
        }
        return this;
    }
    ...
    public StrBuilder replace(int i, int i2, String str) {
        int validateRange = validateRange(i, i2);
        replaceImpl(i, validateRange, validateRange - i, str, StringUtils.length(str));
        return this;
    }
    ...
    public StrBuilder replaceAll(String str, String str2) {
        int length = StringUtils.length(str);
        if (length > 0) {
            int length2 = StringUtils.length(str2);
            int indexOf = indexOf(str, 0);
            while (indexOf >= 0) {
    ...
    public StrBuilder replaceFirst(String str, String str2) {
        ...
        int length = StringUtils.length(str);
        if (length > 0 && (indexOf = indexOf(str, 0)) >= 0) {
            replaceImpl(indexOf, indexOf + length, length, str2, StringUtils.length(str2));
        }
        return this;
    }
    ...
    public int indexOf(String str, int i) {
        return StringUtils.indexOf(this, str, i);
    }
    ...
    public int lastIndexOf(String str, int i) {
        return StringUtils.lastIndexOf(this, str, i);
    }
