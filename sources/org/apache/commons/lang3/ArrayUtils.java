...
public class ArrayUtils {
    ...
    public static boolean containsAny(final Object[] objArr, Object... objArr2) {
        return org.apache.commons.lang3.stream.Streams.of(objArr2).anyMatch(new Predicate() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda7
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean contains;
                contains = ArrayUtils.contains(objArr, obj);
                return contains;
            }
        });
    }
    ...
    public static <T extends Comparable<? super T>> boolean isSorted(T[] tArr) {
        return isSorted(tArr, new Comparator() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda1
    ...
    public static <T> T[] subarray(T[] tArr, int i, int i2) {
        ...
        T[] tArr2 = (T[]) newInstance(componentType, i3);
    ...
    public static Boolean[] toObject(final boolean[] zArr) {
        ...
        return (Boolean[]) setAll(new Boolean[zArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda2
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                return ArrayUtils.lambda$toObject$1(zArr, i);
            }
        });
    }

    public static /* synthetic */ Boolean lambda$toObject$1(boolean[] zArr, int i) {
    ...
    public static Byte[] toObject(final byte[] bArr) {
        ...
        return (Byte[]) setAll(new Byte[bArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda8
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Byte valueOf;
    ...
    public static Character[] toObject(final char[] cArr) {
        ...
        return (Character[]) setAll(new Character[cArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda3
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Character valueOf;
    ...
    public static Double[] toObject(final double[] dArr) {
        ...
        return (Double[]) setAll(new Double[dArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda6
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Double valueOf;
    ...
    public static Float[] toObject(final float[] fArr) {
        ...
        return (Float[]) setAll(new Float[fArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda4
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Float valueOf;
    ...
    public static Integer[] toObject(final int[] iArr) {
        ...
        return (Integer[]) setAll(new Integer[iArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda5
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Integer valueOf;
    ...
    public static Long[] toObject(final long[] jArr) {
        ...
        return (Long[]) setAll(new Long[jArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda0
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Long valueOf;
    ...
    public static Short[] toObject(final short[] sArr) {
        ...
        return (Short[]) setAll(new Short[sArr.length], new IntFunction() { // from class: org.apache.commons.lang3.ArrayUtils$$ExternalSyntheticLambda9
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                Short valueOf;
