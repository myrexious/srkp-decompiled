...
public class StringEscapeUtils {
    ...
    public static final CharSequenceTranslator ESCAPE_JAVA = new LookupTranslator(new String[]{OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\""}, new String[]{"\\", "\\\\"}).with(new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE())).with(JavaUnicodeEscaper.outsideOf(32, 127));
    public static final CharSequenceTranslator ESCAPE_ECMASCRIPT = new AggregateTranslator(new LookupTranslator(new String[]{OperatorName.SHOW_TEXT_LINE, "\\'"}, new String[]{OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\""}, new String[]{"\\", "\\\\"}, new String[]{RemoteSettings.FORWARD_SLASH_STRING, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    public static final CharSequenceTranslator ESCAPE_JSON = new AggregateTranslator(new LookupTranslator(new String[]{OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\""}, new String[]{"\\", "\\\\"}, new String[]{RemoteSettings.FORWARD_SLASH_STRING, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    @Deprecated
    ...
    static {
        AggregateTranslator aggregateTranslator = new AggregateTranslator(new OctalUnescaper(), new UnicodeUnescaper(), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_UNESCAPE()), new LookupTranslator(new String[]{"\\\\", "\\"}, new String[]{"\\\"", OperatorName.SHOW_TEXT_LINE_AND_SPACE}, new String[]{"\\'", OperatorName.SHOW_TEXT_LINE}, new String[]{"\\", ""}));
