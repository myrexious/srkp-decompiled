...
public class DiffBuilder<T> implements Builder<DiffResult<T>> {
    ...
    public DiffBuilder(T t, T t2, ToStringStyle toStringStyle, boolean z) {
        ...
        this.objectsTriviallyEqual = z && Objects.equals(t, t2);
    }
    ...
    public DiffBuilder<T> append(final String str, DiffResult<T> diffResult) {
        validateFieldNameNotNull(str);
        Objects.requireNonNull(diffResult, "diffResult");
        if (this.objectsTriviallyEqual) {
            return this;
        }
        diffResult.getDiffs().forEach(new Consumer() { // from class: org.apache.commons.lang3.builder.DiffBuilder$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DiffBuilder.this.m1849lambda$append$0$orgapachecommonslang3builderDiffBuilder(str, (Diff) obj);
            }
        });
        return this;
    }
    ...
    public /* synthetic */ void m1849lambda$append$0$orgapachecommonslang3builderDiffBuilder(String str, Diff diff) {
