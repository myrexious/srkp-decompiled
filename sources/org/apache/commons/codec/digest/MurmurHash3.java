...
public final class MurmurHash3 {
    ...
    public static int hash32x86(byte[] bArr, int i, int i2, int i3) {
        ...
        i3 ^= Integer.rotateLeft(((bArr[i6] & UByte.MAX_VALUE) ^ r1) * C1_32, 15) * C2_32;
        return fmix32(i3 ^ i2);
    }
    ...
    public static long hash64(int i) {
        return fmix64(((Long.rotateLeft((Integer.reverseBytes(i) & BodyPartID.bodyIdMax) * C1, 31) * C2) ^ 104729) ^ 4);
    }
    ...
    public static long[] hash128x64(byte[] bArr, int i, int i2, int i3) {
        return hash128x64Internal(bArr, i, i2, i3 & BodyPartID.bodyIdMax);
    }
    ...
    private static long[] hash128x64Internal(byte[] bArr, int i, int i2, long j) {
        ...
        switch ((i + i2) - (i + (i4 << 4))) {
            case 1:
                j2 = j9;
                j9 = j2 ^ (Long.rotateLeft((j11 ^ (bArr[i3] & UByte.MAX_VALUE)) * C1, 31) * C2);
                break;
            case 2:
                j2 = j9;
                j11 ^= (bArr[i3 + 1] & 255) << 8;
            ...
            case 9:
                j2 = j9;
                j3 = 0;
                j10 ^= Long.rotateLeft((j3 ^ (bArr[i3 + 8] & UByte.MAX_VALUE)) * C2, 33) * C1;
                j11 = 0 ^ ((bArr[i3 + 7] & 255) << 56);
                j11 ^= (bArr[i3 + 6] & 255) << 48;
                j11 ^= (bArr[i3 + 5] & 255) << 40;
                j11 ^= (bArr[i3 + 4] & 255) << 32;
    ...
    public static class IncrementalHash32x86 {
        ...
        int finalise(int i, int i2, byte[] bArr, int i3) {
            ...
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 == 3) {
                        i5 = ((bArr[2] & UByte.MAX_VALUE) << 16) ^ 0;
                    }
                    return MurmurHash3.fmix32(i ^ i3);
                }
                i5 = 0;
                i4 = i5 ^ ((bArr[1] & UByte.MAX_VALUE) << 8);
            } else {
                i4 = 0;
            }
            i ^= Integer.rotateLeft((i4 ^ (bArr[0] & UByte.MAX_VALUE)) * MurmurHash3.C1_32, 15) * MurmurHash3.C2_32;
            return MurmurHash3.fmix32(i ^ i3);
        }
    }
