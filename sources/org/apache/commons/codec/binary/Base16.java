...
public class Base16 extends BaseNCodec {
    ...
    public void encode(byte[] bArr, int i, int i2, BaseNCodec.Context context) {
        ...
        while (i < i4) {
            ...
            int i6 = context.pos;
            context.pos = i6 + 1;
            ensureBufferSize[i6] = this.encodeTable[b & 15];
            i++;
        }
    }
