...
public class MatchRatingApproachEncoder implements StringEncoder {
    private static final String[] DOUBLE_CONSONANT = {"BB", AFMParser.CC, "DD", "FF", "GG", "HH", "JJ", "KK", "LL", "MM", "NN", "PP", "QQ", "RR", "SS", "TT", AFMParser.CHARMETRICS_VV, "WW", "XX", "YY", "ZZ"};
    ...
    String getFirst3Last3(String str) {
        ...
        if (length > 6) {
            ...
            return substring + str.substring(length - 3, length);
        }
        return str;
    }
    ...
    boolean isVowel(String str) {
        return str.equalsIgnoreCase("E") || str.equalsIgnoreCase("A") || str.equalsIgnoreCase(PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE) || str.equalsIgnoreCase("I") || str.equalsIgnoreCase("U");
    }
    ...
    String removeVowels(String str) {
        ...
        String replaceAll = str.replaceAll("A", "").replaceAll("E", "").replaceAll("I", "").replaceAll(PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE, "").replaceAll("U", "").replaceAll("\\s{2,}\\b", " ");
        return isVowel(substring) ? substring + replaceAll : replaceAll;
    }
}
