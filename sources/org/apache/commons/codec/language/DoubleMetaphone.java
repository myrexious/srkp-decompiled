...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", "B", StandardStructureTypes.H, "F", "V", "W", StringUtils.SPACE};
    ...
    private int handleC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (conditionC0(str, i)) {
            ...
            if (contains(str, i, 2, "CZ") && !contains(str, i - 2, 4, "WICZ")) {
                ...
                } else if (contains(str, i, 2, AFMParser.CC) && (i != 1 || charAt(str, 0) != 'M')) {
    ...
    private int handleCC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        int i2 = i + 2;
        if (contains(str, i2, 1, "I", "E", StandardStructureTypes.H) && !contains(str, i2, 2, "HU")) {
    ...
    private int handleG(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (charAt(str, i2) == 'N') {
        ...
        } else if (contains(str, i2, 2, StandardStructureTypes.LI) && !z) {
            ...
            if (contains(str, i2, 1, "E", "I", "Y") || contains(str, i - 1, 4, "AGGI", "OGGI")) {
                if (contains(str, 0, 4, "VAN ", "VON ") || contains(str, 0, 3, "SCH") || contains(str, i2, 2, OperatorName.END_TEXT)) {
                    doubleMetaphoneResult.append('K');
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (i > 0 && !isVowel(charAt(str, i - 1))) {
            ...
            doubleMetaphoneResult.append('K');
            return i2;
        } else if ((i <= 1 || !contains(str, i - 2, 1, "B", StandardStructureTypes.H, "D")) && ((i <= 2 || !contains(str, i - 3, 1, "B", StandardStructureTypes.H, "D")) && (i <= 3 || !contains(str, i - 4, 1, "B", StandardStructureTypes.H)))) {
    ...
    private int handleT(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (contains(str, i, 4, "TION")) {
            ...
            doubleMetaphoneResult.append('X');
        } else if (contains(str, i, 2, StandardStructureTypes.TH) || contains(str, i, 3, "TTH")) {
            int i2 = i + 2;
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH") && !contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID")) {
            ...
            if (!contains(str, i2, 1, "T", "S")) {
                if (!contains(str, i - 1, 1, "A", PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE, "U", "E") && i != 0) {
                    return false;
                }
    ...
    private boolean conditionL0(String str, int i) {
        ...
        return (contains(str, str.length() - 2, 2, "AS", "OS") || contains(str, str.length() - 1, 1, "A", PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE)) && contains(str, i - 1, 4, "ALLE");
    }
    ...
    public class DoubleMetaphoneResult {
        ...
        public DoubleMetaphoneResult(int i) {
            DoubleMetaphone.this = r3;
            this.primary = new StringBuilder(r3.getMaxCodeLen());
            this.alternate = new StringBuilder(r3.getMaxCodeLen());
            this.maxLength = i;
        }
