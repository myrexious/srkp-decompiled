...
public class FileSystemUtils {
    ...
    static {
        ...
        String str = "df";
        try {
            property = System.getProperty(SystemProperties.OS_NAME);
    ...
    long freeSpaceWindows(String str, long j) throws IOException {
        ...
        if (normalize.length() > 0 && normalize.charAt(0) != '\"') {
            normalize = OperatorName.SHOW_TEXT_LINE_AND_SPACE + normalize + OperatorName.SHOW_TEXT_LINE_AND_SPACE;
        }
        ...
        throw new IOException("Command line 'dir /-c' did not return any info for path '" + normalize + OperatorName.SHOW_TEXT_LINE);
    }
    ...
    long parseDir(String str, String str2) throws IOException {
        ...
        if (length < 0) {
            throw new IOException("Command line 'dir /-c' did not return valid info for path '" + str2 + OperatorName.SHOW_TEXT_LINE);
        }
