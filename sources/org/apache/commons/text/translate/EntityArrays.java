...
public class EntityArrays {
    ...
    static {
        ...
        hashMap4.put(OperatorName.SHOW_TEXT_LINE, "&apos;");
    ...
    public static Map<CharSequence, CharSequence> invert(Map<CharSequence, CharSequence> map) {
        return (Map) map.entrySet().stream().collect(Collectors.toMap(new Function() { // from class: org.apache.commons.text.translate.EntityArrays$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return (CharSequence) ((Map.Entry) obj).getValue();
            }
        }, new Function() { // from class: org.apache.commons.text.translate.EntityArrays$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
