...
public class StrSubstitutor {
    ...
    public static String replace(Object obj, final Properties properties) {
        ...
        return replace(obj, (Map) stream.collect(Collectors.toMap(identity, new Function() { // from class: org.apache.commons.text.StrSubstitutor$$ExternalSyntheticLambda0
            ...
            if (isMatch != 0) {
                ...
                while (true) {
                    if (i12 >= i7) {
                        ...
                        i6 = i12;
                        break;
                    } else if (isEnableSubstitutionInVariables && variablePrefixMatcher.isMatch(cArr, i12, i, i7) != 0) {
                        i13++;
