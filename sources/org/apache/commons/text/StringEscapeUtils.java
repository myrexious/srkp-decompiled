...
public class StringEscapeUtils {
    ...
    static class XsiUnescaper extends CharSequenceTranslator {
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            int i3 = 0;
            while (true) {
                int indexOf = obj.indexOf(92, i2);
                if (indexOf == -1) {
                    break;
                }
                if (indexOf > i3) {
                    writer.write(obj.substring(i3, indexOf));
                }
                i3 = indexOf + 1;
                i2 = indexOf + 2;
            }
            if (i3 < obj.length()) {
                writer.write(obj.substring(i3));
            }
    ...
    static {
        ...
        hashMap.put(OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\"");
        hashMap.put("\\", "\\\\");
        ...
        hashMap2.put(OperatorName.SHOW_TEXT_LINE, "\\'");
        hashMap2.put(OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\"");
        hashMap2.put("\\", "\\\\");
        hashMap2.put(RemoteSettings.FORWARD_SLASH_STRING, "\\/");
        ...
        hashMap3.put(OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\"");
        hashMap3.put("\\", "\\\\");
        hashMap3.put(RemoteSettings.FORWARD_SLASH_STRING, "\\/");
        ...
        hashMap6.put(ElectionUtil.KODE_TPS_SEPARATOR, "\\|");
        hashMap6.put("&", "\\&");
        hashMap6.put(";", "\\;");
        hashMap6.put("<", "\\<");
        hashMap6.put(">", "\\>");
        ...
        hashMap6.put("`", "\\`");
        hashMap6.put("\\", "\\\\");
        hashMap6.put(OperatorName.SHOW_TEXT_LINE_AND_SPACE, "\\\"");
        hashMap6.put(OperatorName.SHOW_TEXT_LINE, "\\'");
        hashMap6.put(StringUtils.SPACE, "\\ ");
        hashMap6.put("\t", "\\\t");
        hashMap6.put(IOUtils.LINE_SEPARATOR_WINDOWS, "");
        hashMap6.put("\n", "");
        hashMap6.put("*", "\\*");
        hashMap6.put("?", "\\?");
        hashMap6.put("[", "\\[");
        ...
        hashMap7.put("\\\\", "\\");
        hashMap7.put("\\\"", OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        hashMap7.put("\\'", OperatorName.SHOW_TEXT_LINE);
        hashMap7.put("\\", "");
