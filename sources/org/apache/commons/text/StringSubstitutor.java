...
public class StringSubstitutor {
    ...
    public static String replace(Object obj, final Properties properties) {
        if (properties == null) {
            return obj.toString();
        }
        ...
        return replace(obj, (Map) stream.collect(Collectors.toMap(identity, new Function() { // from class: org.apache.commons.text.StringSubstitutor$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj2) {
                String property;
                property = properties.getProperty((String) obj2);
                return property;
            }
        })));
    }
    ...
    */
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("StringSubstitutor [disableSubstitutionInValues=");
        sb.append(this.disableSubstitutionInValues).append(", enableSubstitutionInVariables=").append(this.enableSubstitutionInVariables).append(", enableUndefinedVariableException=").append(this.enableUndefinedVariableException).append(", escapeChar=").append(this.escapeChar).append(", prefixMatcher=").append(this.prefixMatcher).append(", preserveEscapes=").append(this.preserveEscapes).append(", suffixMatcher=").append(this.suffixMatcher).append(", valueDelimiterMatcher=").append(this.valueDelimiterMatcher).append(", variableResolver=").append(this.variableResolver).append("]");
        return sb.toString();
    }
}
