...
public class Mat {
    ...
    public int put(int i, int i2, double... dArr) {
        ...
        if (dArr == null || dArr.length % CvType.channels(type) != 0) {
            throw new UnsupportedOperationException("Provided data element number (" + (dArr == null ? 0 : dArr.length) + ") should be multiple of the Mat channels count (" + CvType.channels(type) + ")");
        }
    ...
    public int put(int i, int i2, float[] fArr) {
        ...
        if (fArr == null || fArr.length % CvType.channels(type) != 0) {
            throw new UnsupportedOperationException("Provided data element number (" + (fArr == null ? 0 : fArr.length) + ") should be multiple of the Mat channels count (" + CvType.channels(type) + ")");
    ...
    public int put(int i, int i2, int[] iArr) {
        ...
        if (iArr == null || iArr.length % CvType.channels(type) != 0) {
            throw new UnsupportedOperationException("Provided data element number (" + (iArr == null ? 0 : iArr.length) + ") should be multiple of the Mat channels count (" + CvType.channels(type) + ")");
    ...
    public int put(int i, int i2, short[] sArr) {
        ...
        if (sArr == null || sArr.length % CvType.channels(type) != 0) {
            throw new UnsupportedOperationException("Provided data element number (" + (sArr == null ? 0 : sArr.length) + ") should be multiple of the Mat channels count (" + CvType.channels(type) + ")");
    ...
    public int put(int i, int i2, byte[] bArr) {
        ...
        if (bArr == null || bArr.length % CvType.channels(type) != 0) {
            throw new UnsupportedOperationException("Provided data element number (" + (bArr == null ? 0 : bArr.length) + ") should be multiple of the Mat channels count (" + CvType.channels(type) + ")");
