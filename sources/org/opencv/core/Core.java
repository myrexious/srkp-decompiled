...
public class Core {
    ...
    public static void divide(Mat mat, Scalar scalar, Mat mat2, double d, int i) {
        divide_3(mat.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], mat2.nativeObj, d, i);
    }

    public static void divide(Mat mat, Scalar scalar, Mat mat2, double d) {
        divide_4(mat.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], mat2.nativeObj, d);
    }
