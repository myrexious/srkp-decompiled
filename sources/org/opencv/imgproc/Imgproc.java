...
public class Imgproc {
    ...
    private static native float EMD_1(long j, long j2, int i);
    ...
    private static native void goodFeaturesToTrack_1(long j, long j2, int i, double d, double d2, long j3, int i2, int i3);

    private static native void goodFeaturesToTrack_2(long j, long j2, int i, double d, double d2, long j3, int i2, boolean z, double d3);

    private static native void goodFeaturesToTrack_3(long j, long j2, int i, double d, double d2);
    ...
    public static float EMD(Mat mat, Mat mat2, int i) {
        return EMD_1(mat.nativeObj, mat2.nativeObj, i);
    }
    ...
    public static int floodFill(Mat mat, Mat mat2, Point point, Scalar scalar, Rect rect, Scalar scalar2, Scalar scalar3, int i) {
        ...
        int floodFill_0 = floodFill_0(mat.nativeObj, mat2.nativeObj, point.x, point.y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dArr, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], scalar3.val[0], scalar3.val[1], scalar3.val[2], scalar3.val[3], i);
        if (rect != null) {
            rect.x = (int) dArr[0];
            rect.y = (int) dArr[1];
    ...
    public static void Canny(Mat mat, Mat mat2, double d, double d2) {
        Canny_3(mat.nativeObj, mat2.nativeObj, d, d2);
    }
    ...
    public static void circle(Mat mat, Point point, int i, Scalar scalar, int i2) {
        circle_1(mat.nativeObj, point.x, point.y, i, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i2);
    }

    public static void circle(Mat mat, Point point, int i, Scalar scalar) {
        circle_2(mat.nativeObj, point.x, point.y, i, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void drawContours(Mat mat, List<MatOfPoint> list, int i, Scalar scalar, int i2) {
        drawContours_1(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, i, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i2);
    }

    public static void drawContours(Mat mat, List<MatOfPoint> list, int i, Scalar scalar) {
        drawContours_2(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, i, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void ellipse(Mat mat, Point point, Size size, double d, double d2, double d3, Scalar scalar, int i) {
        ellipse_1(mat.nativeObj, point.x, point.y, size.width, size.height, d, d2, d3, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }

    public static void ellipse(Mat mat, Point point, Size size, double d, double d2, double d3, Scalar scalar) {
        ellipse_2(mat.nativeObj, point.x, point.y, size.width, size.height, d, d2, d3, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void ellipse(Mat mat, RotatedRect rotatedRect, Scalar scalar, int i, int i2) {
        ellipse_3(mat.nativeObj, rotatedRect.center.x, rotatedRect.center.y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i, i2);
    }

    public static void ellipse(Mat mat, RotatedRect rotatedRect, Scalar scalar, int i) {
        ellipse_4(mat.nativeObj, rotatedRect.center.x, rotatedRect.center.y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }
    ...
    public static void fillPoly(Mat mat, List<MatOfPoint> list, Scalar scalar) {
        fillPoly_1(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2, Mat mat2, int i2, int i3) {
        goodFeaturesToTrack_1(mat.nativeObj, matOfPoint.nativeObj, i, d, d2, mat2.nativeObj, i2, i3);
    }
    ...
    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2, Mat mat2, int i2, boolean z, double d3) {
        goodFeaturesToTrack_2(mat.nativeObj, matOfPoint.nativeObj, i, d, d2, mat2.nativeObj, i2, z, d3);
    }

    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2) {
        goodFeaturesToTrack_3(mat.nativeObj, matOfPoint.nativeObj, i, d, d2);
    }
    ...
    public static void line(Mat mat, Point point, Point point2, Scalar scalar, int i) {
        line_1(mat.nativeObj, point.x, point.y, point2.x, point2.y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }
    ...
    public static void polylines(Mat mat, List<MatOfPoint> list, boolean z, Scalar scalar, int i) {
        polylines_1(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, z, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }

    public static void polylines(Mat mat, List<MatOfPoint> list, boolean z, Scalar scalar) {
        polylines_2(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, z, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void putText(Mat mat, String str, Point point, int i, double d, Scalar scalar, int i2) {
        putText_1(mat.nativeObj, str, point.x, point.y, i, d, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i2);
    }

    public static void putText(Mat mat, String str, Point point, int i, double d, Scalar scalar) {
        putText_2(mat.nativeObj, str, point.x, point.y, i, d, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void rectangle(Mat mat, Point point, Point point2, Scalar scalar, int i) {
        rectangle_1(mat.nativeObj, point.x, point.y, point2.x, point2.y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }
