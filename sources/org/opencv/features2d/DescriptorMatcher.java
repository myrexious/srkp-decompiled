...
public class DescriptorMatcher extends Algorithm {
    ...
    public void knnMatch(Mat mat, Mat mat2, List<MatOfDMatch> list, int i) {
        Mat mat3 = new Mat();
        knnMatch_1(this.nativeObj, mat.nativeObj, mat2.nativeObj, mat3.nativeObj, i);
    ...
    public void knnMatch(Mat mat, List<MatOfDMatch> list, int i, List<Mat> list2, boolean z) {
        Mat mat2 = new Mat();
        knnMatch_2(this.nativeObj, mat.nativeObj, mat2.nativeObj, i, Converters.vector_Mat_to_Mat(list2).nativeObj, z);
    ...
    public void knnMatch(Mat mat, List<MatOfDMatch> list, int i) {
        Mat mat2 = new Mat();
        knnMatch_3(this.nativeObj, mat.nativeObj, mat2.nativeObj, i);
        Converters.Mat_to_vector_vector_DMatch(mat2, list);
        mat2.release();
    }
    ...
    public void radiusMatch(Mat mat, Mat mat2, List<MatOfDMatch> list, float f) {
        Mat mat3 = new Mat();
        radiusMatch_1(this.nativeObj, mat.nativeObj, mat2.nativeObj, mat3.nativeObj, f);
        Converters.Mat_to_vector_vector_DMatch(mat3, list);
        mat3.release();
    }
    ...
    public void radiusMatch(Mat mat, List<MatOfDMatch> list, float f, List<Mat> list2, boolean z) {
        Mat mat2 = new Mat();
        radiusMatch_2(this.nativeObj, mat.nativeObj, mat2.nativeObj, f, Converters.vector_Mat_to_Mat(list2).nativeObj, z);
        Converters.Mat_to_vector_vector_DMatch(mat2, list);
        mat2.release();
    }
    ...
    public void radiusMatch(Mat mat, List<MatOfDMatch> list, float f) {
        Mat mat2 = new Mat();
        radiusMatch_3(this.nativeObj, mat.nativeObj, mat2.nativeObj, f);
        Converters.Mat_to_vector_vector_DMatch(mat2, list);
        mat2.release();
    }
