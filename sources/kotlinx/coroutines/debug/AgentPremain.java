...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m273constructorimpl = Result.m273constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m273constructorimpl = Result.m273constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m279isFailureimpl(m273constructorimpl) ? null : m273constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1804installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1804installSignalHandler$lambda1(Signal signal) {
