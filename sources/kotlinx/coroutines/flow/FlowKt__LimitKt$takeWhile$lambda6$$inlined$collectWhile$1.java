...
/* renamed from: kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$lambda-6$$inlined$collectWhile$1 */
...
public final class FlowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public AnonymousClass1(Continuation continuation) {
            super(continuation);
            FlowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1.this = r1;
        }
