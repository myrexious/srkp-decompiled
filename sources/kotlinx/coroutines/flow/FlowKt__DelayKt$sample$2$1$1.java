...
final class FlowKt__DelayKt$sample$2$1$1 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1811invokeWpGqRn0(channelResult.m1799unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0 */
    public final Object m1811invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$1$1) create(ChannelResult.m1787boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            ?? m1799unboximpl = ((ChannelResult) this.L$0).m1799unboximpl();
            Ref.ObjectRef<Object> objectRef = this.$lastValue;
            boolean z = m1799unboximpl instanceof ChannelResult.Failed;
            if (!z) {
                objectRef.element = m1799unboximpl;
            }
