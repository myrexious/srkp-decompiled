...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> function0, Function0<Unit> function02) {
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj2, invoke)) {
                    return;
                }
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    function02.invoke();
                    return;
                }
            } else {
    ...
    public final Object getResult() {
        ...
        if (obj4 == obj) {
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj3, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            if (obj5 == obj2) {
                ...
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _result$FU;
                obj3 = SelectKt.UNDECIDED;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj3, state$default)) {
                    return;
                }
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj4)) {
                    if (Result.m279isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m276exceptionOrNullimpl = Result.m276exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(m276exceptionOrNullimpl);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m276exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m276exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(m276exceptionOrNullimpl)));
                        return;
                    }
    ...
    public void resumeSelectWithException(Throwable th) {
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                Continuation<R> continuation = this.uCont;
                CompletedExceptionally completedExceptionally = new CompletedExceptionally((DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(th, (CoroutineStackFrame) continuation) : th, false, 2, null);
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _result$FU;
                obj2 = SelectKt.UNDECIDED;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj2, completedExceptionally)) {
                    return;
                }
            } else if (obj4 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = _result$FU;
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");
