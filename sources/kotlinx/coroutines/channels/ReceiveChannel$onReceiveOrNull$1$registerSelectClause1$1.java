...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1803invokeWpGqRn0(((ChannelResult) obj).m1799unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0 */
    public final Object m1803invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1787boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1799unboximpl = ((ChannelResult) this.L$0).m1799unboximpl();
            Throwable m1791exceptionOrNullimpl = ChannelResult.m1791exceptionOrNullimpl(m1799unboximpl);
            if (m1791exceptionOrNullimpl != null) {
                throw m1791exceptionOrNullimpl;
            }
            Object m1792getOrNullimpl = ChannelResult.m1792getOrNullimpl(m1799unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1792getOrNullimpl, this);
