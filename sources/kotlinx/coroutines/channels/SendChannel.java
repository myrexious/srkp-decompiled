...
public interface SendChannel<E> {
    ...
    Object mo1782trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1797isSuccessimpl(mo1782trySendJP2dKIU)) {
                return true;
            }
            Throwable m1791exceptionOrNullimpl = ChannelResult.m1791exceptionOrNullimpl(mo1782trySendJP2dKIU);
