...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1782trySendJP2dKIU = sendChannel.mo1782trySendJP2dKIU(e);
        if (mo1782trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1799unboximpl();
        }
        Unit unit = (Unit) mo1782trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1797isSuccessimpl(sendChannel.mo1782trySendJP2dKIU(e))) {
            return;
        }
