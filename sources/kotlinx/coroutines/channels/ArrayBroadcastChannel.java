    ...
    */
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r14, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r15) {
        ...
        L0:
            ...
            r0.lock()
            if (r14 == 0) goto L24
            long r1 = r13.getTail()     // Catch: java.lang.Throwable -> L21
            r14.setSubHead(r1)     // Catch: java.lang.Throwable -> L21
            java.util.List<kotlinx.coroutines.channels.ArrayBroadcastChannel$Subscriber<E>> r1 = r13.subscribers     // Catch: java.lang.Throwable -> L21
            boolean r1 = r1.isEmpty()     // Catch: java.lang.Throwable -> L21
            java.util.List<kotlinx.coroutines.channels.ArrayBroadcastChannel$Subscriber<E>> r2 = r13.subscribers     // Catch: java.lang.Throwable -> L21
            r2.add(r14)     // Catch: java.lang.Throwable -> L21
            if (r1 != 0) goto L24
            r0.unlock()
            return
        L21:
        ...
        L24:
            if (r15 == 0) goto L3b
            java.util.List<kotlinx.coroutines.channels.ArrayBroadcastChannel$Subscriber<E>> r14 = r13.subscribers     // Catch: java.lang.Throwable -> L21
            r14.remove(r15)     // Catch: java.lang.Throwable -> L21
            long r1 = r13.getHead()     // Catch: java.lang.Throwable -> L21
            long r14 = r15.getSubHead()     // Catch: java.lang.Throwable -> L21
            int r14 = (r1 > r14 ? 1 : (r1 == r14 ? 0 : -1))
            if (r14 == 0) goto L3b
            r0.unlock()
            return
        L3b:
            long r14 = r13.computeMinHead()     // Catch: java.lang.Throwable -> L21
            long r1 = r13.getTail()     // Catch: java.lang.Throwable -> L21
            long r3 = r13.getHead()     // Catch: java.lang.Throwable -> L21
            long r14 = kotlin.ranges.RangesKt.coerceAtMost(r14, r1)     // Catch: java.lang.Throwable -> L21
            int r5 = (r14 > r3 ? 1 : (r14 == r3 ? 0 : -1))
            if (r5 > 0) goto L53
            r0.unlock()
            return
        L53:
            int r5 = r13.getSize()     // Catch: java.lang.Throwable -> L21
        L57:
            int r6 = (r3 > r14 ? 1 : (r3 == r14 ? 0 : -1))
            if (r6 >= 0) goto Lc8
            java.lang.Object[] r6 = r13.buffer     // Catch: java.lang.Throwable -> L21
            int r7 = r13.capacity     // Catch: java.lang.Throwable -> L21
        ...
        L6d:
            r10 = 1
            long r3 = r3 + r10
            r13.setHead(r3)     // Catch: java.lang.Throwable -> L21
            int r5 = r5 + (-1)
            r13.setSize(r5)     // Catch: java.lang.Throwable -> L21
            if (r7 == 0) goto L57
        L7a:
            kotlinx.coroutines.channels.Send r7 = r13.takeFirstSendOrPeekClosed()     // Catch: java.lang.Throwable -> L21
            if (r7 != 0) goto L81
            goto L57
        L81:
            boolean r12 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L21
            if (r12 != 0) goto L57
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)     // Catch: java.lang.Throwable -> L21
            kotlinx.coroutines.internal.Symbol r12 = r7.tryResumeSend(r9)     // Catch: java.lang.Throwable -> L21
            if (r12 == 0) goto L7a
            boolean r14 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L21
            if (r14 == 0) goto La2
            kotlinx.coroutines.internal.Symbol r14 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch: java.lang.Throwable -> L21
            if (r12 != r14) goto L99
            r6 = r8
        L99:
            if (r6 == 0) goto L9c
        ...
        La2:
            java.lang.Object[] r14 = r13.buffer     // Catch: java.lang.Throwable -> L21
            int r15 = r13.capacity     // Catch: java.lang.Throwable -> L21
            long r3 = (long) r15     // Catch: java.lang.Throwable -> L21
            long r3 = r1 % r3
            int r15 = (int) r3     // Catch: java.lang.Throwable -> L21
            java.lang.Object r3 = r7.getPollResult()     // Catch: java.lang.Throwable -> L21
            r14[r15] = r3     // Catch: java.lang.Throwable -> L21
            int r5 = r5 + 1
            r13.setSize(r5)     // Catch: java.lang.Throwable -> L21
            long r1 = r1 + r10
            r13.setTail(r1)     // Catch: java.lang.Throwable -> L21
