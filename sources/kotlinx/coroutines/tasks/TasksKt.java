...
public final class TasksKt {
        ...
        if (task.isComplete()) {
            ...
            task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$$ExternalSyntheticLambda0
                ...
                public final void onComplete(Task task2) {
                    TasksKt.m1842asDeferredImpl$lambda0(CompletableDeferred.this, task2);
                }
            });
        }
    ...
    /* renamed from: asDeferredImpl$lambda-0 */
    public static final void m1842asDeferredImpl$lambda0(CompletableDeferred completableDeferred, Task task) {
        Exception exception = task.getException();
        if (exception == null) {
            if (task.isCanceled()) {
        ...
        task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$awaitImpl$2$1
            ...
            public final void onComplete(Task<T> task2) {
                ...
                if (exception2 == null) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m273constructorimpl(task2.getResult()));
                    return;
                }
                Result.Companion companion2 = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
        if (cancellationTokenSource != null) {
