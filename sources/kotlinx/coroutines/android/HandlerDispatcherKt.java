...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m273constructorimpl = Result.m273constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m273constructorimpl = Result.m273constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m279isFailureimpl(m273constructorimpl) ? null : m273constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1828dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1778postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }

    /* renamed from: postFrameCallback$lambda-6 */
    public static final void m1778postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
