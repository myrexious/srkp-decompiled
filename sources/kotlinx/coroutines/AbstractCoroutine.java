...
public abstract class AbstractCoroutine<T> extends JobSupport implements Job, Continuation<T>, CoroutineScope {
    ...
    public String nameString$kotlinx_coroutines_core() {
        ...
        return coroutineName == null ? super.nameString$kotlinx_coroutines_core() : OperatorName.SHOW_TEXT_LINE_AND_SPACE + coroutineName + "\":" + super.nameString$kotlinx_coroutines_core();
    }
