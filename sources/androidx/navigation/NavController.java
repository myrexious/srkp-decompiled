...
public class NavController {
    ...
    private final boolean executePopOperations(List<? extends Navigator<?>> list, NavDestination navDestination, boolean z, final boolean z2) {
        ...
        while (it.hasNext()) {
            ...
            popBackStackInternal((Navigator) it.next(), this.backQueue.last(), z2, new Function1<NavBackStackEntry, Unit>() { // from class: androidx.navigation.NavController$executePopOperations$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
        ...
        if (z2) {
            ...
            if (!arrayDeque.isEmpty()) {
                ...
                for (NavDestination navDestination3 : SequencesKt.takeWhile(SequencesKt.generateSequence(findDestination(first.getDestinationId()), new Function1<NavDestination, NavDestination>() { // from class: androidx.navigation.NavController$executePopOperations$5
                    @Override // kotlin.jvm.functions.Function1
                    public final NavDestination invoke(NavDestination destination) {
                        Intrinsics.checkNotNullParameter(destination, "destination");
                        NavGraph parent = destination.getParent();
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:125:0x0030  */
    ...
    */
    ...
    private final void navigate(final NavDestination navDestination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if ((navOptions != null && navOptions.shouldRestoreState()) && this.backStackMap.containsKey(Integer.valueOf(navDestination.getId()))) {
            ...
            if (!z) {
                navigateInternal(this._navigatorProvider.getNavigator(navDestination.getNavigatorName()), CollectionsKt.listOf(NavBackStackEntry.Companion.create$default(NavBackStackEntry.Companion, this.context, navDestination, addInDefaultArgs, getHostLifecycleState$navigation_runtime_release(), this.viewModel, null, null, 96, null)), navOptions, extras, new Function1<NavBackStackEntry, Unit>() { // from class: androidx.navigation.NavController$navigate$4
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public final void invoke2(NavBackStackEntry it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        Ref.BooleanRef.this.element = true;
                        NavController.addEntryToBackStack$default(this, navDestination, addInDefaultArgs, it, null, 8, null);
                    }
                });
            }
        }
    ...
    private final boolean executeRestoreState(final List<NavBackStackEntry> list, final Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        for (List<NavBackStackEntry> list3 : arrayList) {
            ...
            navigateInternal(navigator, list3, navOptions, extras, new Function1<NavBackStackEntry, Unit>() { // from class: androidx.navigation.NavController$executeRestoreState$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
