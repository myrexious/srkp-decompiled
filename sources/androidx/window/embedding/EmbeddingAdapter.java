...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            public final boolean test(Object obj) {
                boolean m114translateActivityPairPredicates$lambda1;
                m114translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m114translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m114translateActivityPairPredicates$lambda1;
            }
        };
    }

    /* renamed from: translateActivityPairPredicates$lambda-1 */
    public static final boolean m114translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m113translateActivityIntentPredicates$lambda3;
                m113translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m113translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m113translateActivityIntentPredicates$lambda3;
            }
        };
    }

    /* renamed from: translateActivityIntentPredicates$lambda-3 */
    public static final boolean m113translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m117translateParentMetricsPredicate$lambda4;
                m117translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m117translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m117translateParentMetricsPredicate$lambda4;
            }
        };
    }

    /* renamed from: translateParentMetricsPredicate$lambda-4 */
    public static final boolean m117translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m115translateActivityPredicates$lambda6;
                m115translateActivityPredicates$lambda6 = EmbeddingAdapter.m115translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m115translateActivityPredicates$lambda6;
            }
        };
    }

    /* renamed from: translateActivityPredicates$lambda-6 */
    public static final boolean m115translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m116translateIntentPredicates$lambda8;
                m116translateIntentPredicates$lambda8 = EmbeddingAdapter.m116translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m116translateIntentPredicates$lambda8;
            }
        };
    }

    /* renamed from: translateIntentPredicates$lambda-8 */
    public static final boolean m116translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
