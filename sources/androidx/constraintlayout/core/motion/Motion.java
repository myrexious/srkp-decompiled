    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (keyCycleOscillator2 != null) {
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + keyCycleOscillator2.get(f8);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i6].customAttributes.containsKey(str6) && (customVariable = motionPathsArr[i6].customAttributes.get(str6)) != null) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                if (motionPathsArr[i17].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance(Double.TYPE, size, motionPathsArr[i17].getCustomDataCount(str8));
                    }
