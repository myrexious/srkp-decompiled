...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i26 = (int) (i6 + (f5 * (i18 - i9)));
        widgetFrame.top = i26;
        float f10 = 1.0f - f;
        widgetFrame.right = i25 + ((int) ((i3 * f10) + (i21 * f)));
        widgetFrame.bottom = i26 + ((int) ((f10 * i4) + (i22 * f)));
    ...
    void printCustomAttributes() {
        ...
        if (this.widget != null) {
            str = str2 + RemoteSettings.FORWARD_SLASH_STRING + (this.widget.hashCode() % 1000) + StringUtils.SPACE;
        } else {
            str = str2 + "/NULL ";
        }
