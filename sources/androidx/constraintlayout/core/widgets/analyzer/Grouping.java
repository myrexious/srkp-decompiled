...
public class Grouping {
    ...
    /* JADX WARN: Removed duplicated region for block: B:427:0x035f  */
    /* JADX WARN: Removed duplicated region for block: B:439:0x039b  */
    /* JADX WARN: Removed duplicated region for block: B:442:0x03a0 A[ADDED_TO_REGION] */
    /*
    ...
    */
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (i2 != -1 && (widgetGroup == null || i2 != widgetGroup.f5id)) {
            int i3 = 0;
            while (true) {
