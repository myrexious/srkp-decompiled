...
public class ConstraintLayoutStates {
                ...
                if (eventType == 0) {
                    ...
                    switch (name.hashCode()) {
                        case -1349929691:
                            ...
                            break;
                        case 80204913:
                            if (name.equals(PhotoshopSchema.STATE)) {
                                c = 2;
                                break;
                            }
                            c = 65535;
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (attributeName != null && attributeValue != null && JobType.ID.equals(attributeName)) {
                int identifier = attributeValue.contains(RemoteSettings.FORWARD_SLASH_STRING) ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), JobType.ID, context.getPackageName()) : -1;
                if (identifier == -1) {
