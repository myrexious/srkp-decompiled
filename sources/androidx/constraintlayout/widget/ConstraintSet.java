    ...
    */
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m19clone());
            }
        }
    }
    ...
    */
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            if (i == 0) {
                i = context.getResources().getIdentifier(trim, JobType.ID, context.getPackageName());
            }
    ...
    static String getLine(Context context, int resourceId, XmlPullParser pullParser) {
        return ".(" + Debug.getName(context, resourceId) + ".xml:" + pullParser.getLineNumber() + ") \"" + pullParser.getName() + OperatorName.SHOW_TEXT_LINE_AND_SPACE;
    }
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                this.writer.write("\n       android:id=\"" + name + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        ...
        private void writeEnum(String dimString, int val, String[] types, int def) throws IOException {
            if (val != def) {
                this.writer.write(SPACE + dimString + "=\"" + types[val] + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            }
        }
        ...
        void writeXmlConstraint(String str, int leftToLeft) throws IOException {
            ...
            this.writer.write("=\"" + getName(leftToLeft) + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        }
        ...
        void writeVariable(String name, float value, float def) throws IOException {
            ...
            this.writer.write("=\"" + value + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        }
    ...
    class WriteJsonEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                Layout layout = ((Constraint) ConstraintSet.this.mConstraints.get(num)).layout;
                writeDimension(ThumbnailType.HEIGHT, layout.mHeight, layout.heightDefault, layout.heightPercent, layout.heightMin, layout.heightMax, layout.constrainedHeight);
                writeDimension(ThumbnailType.WIDTH, layout.mWidth, layout.widthDefault, layout.widthPercent, layout.widthMin, layout.widthMax, layout.constrainedWidth);
        ...
        String getName(int id2) {
            if (this.idMap.containsKey(Integer.valueOf(id2))) {
                return OperatorName.SHOW_TEXT_LINE + this.idMap.get(Integer.valueOf(id2)) + OperatorName.SHOW_TEXT_LINE;
            }
            if (id2 == 0) {
                return "'parent'";
            }
            String lookup = lookup(id2);
            this.idMap.put(Integer.valueOf(id2), lookup);
            return OperatorName.SHOW_TEXT_LINE + lookup + OperatorName.SHOW_TEXT_LINE;
        }
