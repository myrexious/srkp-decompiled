...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute att, View view, float[] value) {
        ...
        try {
            ...
            Log.e(TAG, "cannot access method " + str + " on View \"" + Debug.getName(view) + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            e.printStackTrace();
        } catch (NoSuchMethodException e2) {
            Log.e(TAG, "no method " + str + " on View \"" + Debug.getName(view) + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            e2.printStackTrace();
