    ...
    */
    ...
    public class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            String str = title + StringUtils.SPACE + Debug.getName((View) c.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + StringUtils.SPACE + constraintWidget + StringUtils.SPACE + str3);
            }
