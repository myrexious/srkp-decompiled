    ...
    public void buildPath(float[] points, int pointCount) {
        ...
        while (i < pointCount) {
            ...
            if (viewOscillator != null) {
                points[i2] = points[i2] + viewOscillator.get(f8);
            } else if (viewSpline != null) {
                points[i2] = points[i2] + viewSpline.get(f8);
            }
            if (viewOscillator2 != null) {
                int i4 = i2 + 1;
                points[i4] = points[i4] + viewOscillator2.get(f8);
            } else if (viewSpline2 != null) {
                int i5 = i2 + 1;
                points[i5] = points[i5] + viewSpline2.get(f8);
            }
            i = i3 + 1;
            f2 = 1.0f;
        }
