...
public class FragmentStateManager {
    ...
    void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "requestFocus: Restoring focused view " + focusedView + StringUtils.SPACE + (requestFocus ? "succeeded" : "failed") + " on Fragment " + this.mFragment + " resulting in focused view " + this.mFragment.mView.findFocus());
            }
        }
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle m60lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m60lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!m60lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, m60lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
