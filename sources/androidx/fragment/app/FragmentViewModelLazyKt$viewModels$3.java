...
public final class FragmentViewModelLazyKt$viewModels$3 extends Lambda implements Function0<CreationExtras> {
    ...
    public final CreationExtras invoke() {
        ViewModelStoreOwner m67viewModels$lambda0;
        CreationExtras defaultViewModelCreationExtras;
        m67viewModels$lambda0 = FragmentViewModelLazyKt.m67viewModels$lambda0(this.$owner$delegate);
        HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m67viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m67viewModels$lambda0 : null;
