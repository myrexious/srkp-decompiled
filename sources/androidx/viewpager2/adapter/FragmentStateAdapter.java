...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    void placeFragmentInViewHolder(final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment.isAdded() && view == null) {
            ...
            scheduleViewAttach(fragment, container);
            this.mFragmentManager.beginTransaction().add(fragment, OperatorName.FILL_NON_ZERO + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
