...
public class ProfileTranscoder {
    ...
    static final byte[] MAGIC_PROF = {BuiltinOptions.ReadVariableOptions, BuiltinOptions.RandomOptions, BuiltinOptions.VarHandleOptions, 0};
    static final byte[] MAGIC_PROFM = {BuiltinOptions.ReadVariableOptions, BuiltinOptions.RandomOptions, BuiltinOptions.HashtableImportOptions, 0};
