...
public class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            ImageView imageView = (ImageView) convertView.findViewById(R.id.browser_actions_menu_item_icon);
            TextView textView = (TextView) convertView.findViewById(R.id.browser_actions_menu_item_text);
