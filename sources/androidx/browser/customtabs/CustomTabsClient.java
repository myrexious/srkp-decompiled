...
public class CustomTabsClient {
    ...
    public CustomTabsSession newSession(final CustomTabsCallback callback, int id2) {
        return newSessionInternal(callback, createSessionId(this.mApplicationContext, id2));
    }

    public static CustomTabsSession.PendingSession newPendingSession(Context context, final CustomTabsCallback callback, int id2) {
        return new CustomTabsSession.PendingSession(callback, createSessionId(context, id2));
    }
