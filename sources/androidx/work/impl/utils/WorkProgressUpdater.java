...
public class WorkProgressUpdater implements ProgressUpdater {
    ...
    public ListenableFuture<Void> updateProgress(final Context context, final UUID id2, final Data data) {
        ...
        this.mTaskExecutor.executeOnBackgroundThread(new Runnable() { // from class: androidx.work.impl.utils.WorkProgressUpdater.1
            ...
            public void run() {
                ...
                Logger.get().debug(WorkProgressUpdater.TAG, String.format("Updating progress for %s (%s)", id2, data), new Throwable[0]);
