...
public abstract class StatusRunnable<T> implements Runnable {
    ...
    public static StatusRunnable<WorkInfo> forUUID(final WorkManagerImpl workManager, final UUID id2) {
        return new StatusRunnable<WorkInfo>() { // from class: androidx.work.impl.utils.StatusRunnable.2
            @Override // androidx.work.impl.utils.StatusRunnable
            public WorkInfo runInternal() {
                WorkSpec.WorkInfoPojo workStatusPojoForId = workManager.getWorkDatabase().workSpecDao().getWorkStatusPojoForId(id2.toString());
