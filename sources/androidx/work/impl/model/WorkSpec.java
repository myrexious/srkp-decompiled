...
public final class WorkSpec {
    ...
    public WorkSpec(String id2, String workerClassName) {
    ...
    public int hashCode() {
        int hashCode = ((((this.f14id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public String toString() {
        return "{WorkSpec: " + this.f14id + StringSubstitutor.DEFAULT_VAR_END;
    }
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof IdAndState) {
                ...
                return this.f15id.equals(idAndState.f15id);
            }
            return false;
        }

        public int hashCode() {
            return (this.f15id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f16id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof WorkInfoPojo) {
                ...
                if (str == null ? workInfoPojo.f16id == null : str.equals(workInfoPojo.f16id)) {
