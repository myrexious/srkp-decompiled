...
public class WorkManagerImpl extends WorkManager {
    ...
    */
    ...
    @Override // androidx.work.WorkManager
    public Operation cancelWorkById(UUID id2) {
        CancelWorkRunnable forId = CancelWorkRunnable.forId(id2, this);
    ...
    @Override // androidx.work.WorkManager
    public PendingIntent createCancelPendingIntent(UUID id2) {
        return PendingIntent.getService(this.mContext, 0, SystemForegroundDispatcher.createCancelWorkIntent(this.mContext, id2.toString()), BuildCompat.isAtLeastS() ? 167772160 : 134217728);
    }
    ...
    @Override // androidx.work.WorkManager
    public LiveData<WorkInfo> getWorkInfoByIdLiveData(UUID id2) {
        return LiveDataUtils.dedupedMappedLiveDataFor(this.mWorkDatabase.workSpecDao().getWorkStatusPojoLiveDataForIds(Collections.singletonList(id2.toString())), new Function<List<WorkSpec.WorkInfoPojo>, WorkInfo>() { // from class: androidx.work.impl.WorkManagerImpl.2
    ...
    @Override // androidx.work.WorkManager
    public ListenableFuture<WorkInfo> getWorkInfoById(UUID id2) {
        StatusRunnable<WorkInfo> forUUID = StatusRunnable.forUUID(this, id2);
