...
public interface IWorkManagerImpl extends IInterface {
    ...
    public static class Default implements IWorkManagerImpl {
        ...
        @Override // androidx.work.multiprocess.IWorkManagerImpl
        public void cancelWorkById(String id2, IWorkManagerImplCallback callback) throws RemoteException {
        }
    ...
    void cancelWorkById(String id2, IWorkManagerImplCallback callback) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IWorkManagerImpl {
        ...
        public static class Proxy implements IWorkManagerImpl {
            ...
            public void cancelWorkById(String id2, IWorkManagerImplCallback callback) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(id2);
                    obtain.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (this.mRemote.transact(3, obtain, null, 1) || Stub.getDefaultImpl() == null) {
                        return;
                    }
                    Stub.getDefaultImpl().cancelWorkById(id2, callback);
                } finally {
                    obtain.recycle();
                }
            }
