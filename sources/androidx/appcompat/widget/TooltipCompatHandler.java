...
public class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.TooltipCompatHandler$$ExternalSyntheticLambda0
        ...
        public final void run() {
            TooltipCompatHandler.this.m9lambda$new$0$androidxappcompatwidgetTooltipCompatHandler();
        }
    };
    ...
    /* renamed from: lambda$new$0$androidx-appcompat-widget-TooltipCompatHandler */
    public /* synthetic */ void m9lambda$new$0$androidxappcompatwidgetTooltipCompatHandler() {
        show(false);
    }
