...
public final class Utf8 {
            ...
            while (estimateConsecutiveAscii < i2) {
                ...
                if (b < 0) {
                    if (b < -32) {
                        ...
                        if (b2 <= -65 && (((b << BuiltinOptions.SubOptions) + (b2 + BuiltinOptions.ReadVariableOptions)) >> 30) == 0) {
                            int i5 = i4 + 1;
    ...
    public static class DecodeUtil {
        ...
        private static int trailingByteValue(byte b) {
            return b & BuiltinOptions.LogicalNotOptions;
        }
        ...
        public static void handleTwoBytes(byte b, byte b2, char[] cArr, int i) throws InvalidProtocolBufferException {
            ...
            cArr[i] = (char) (((b & BuiltinOptions.SequenceRNNOptions) << 6) | trailingByteValue(b2));
        }
        ...
        public static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws InvalidProtocolBufferException {
            if (isNotTrailingByte(b2) || (((b << BuiltinOptions.SubOptions) + (b2 + BuiltinOptions.ReadVariableOptions)) >> 30) != 0 || isNotTrailingByte(b3) || isNotTrailingByte(b4)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
