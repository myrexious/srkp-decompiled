...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(Intent intent) {
        ...
        synchronized (this.mReceivers) {
            ...
            boolean z3 = true;
            byte b = (intent.getFlags() & 8) != 0 ? (byte) 1 : (byte) 0;
            if (b != 0) {
                ...
                while (i2 < arrayList2.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : "type" : Constants.ScionAnalytics.MessageType.DATA_MESSAGE : ResourceEventType.ACTION : PDFAPropertyType.CATEGORY));
                        }
                    }
                    i2 = i + 1;
                    z3 = z2;
