...
public final class ContentInfoCompat {
    ...
    private static final class CompatImpl implements Compat {
        ...
        public String toString() {
            return "ContentInfoCompat{clip=" + this.mClip.getDescription() + ", source=" + ContentInfoCompat.sourceToString(this.mSource) + ", flags=" + ContentInfoCompat.flagsToString(this.mFlags) + (this.mLinkUri == null ? "" : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")") + (this.mExtras != null ? ", hasExtras" : "") + StringSubstitutor.DEFAULT_VAR_END;
        }
    }
    ...
    public static final class Compat31Impl implements Compat {
        ...
        public String toString() {
            return "ContentInfoCompat{" + this.mWrapped + StringSubstitutor.DEFAULT_VAR_END;
        }
    }
