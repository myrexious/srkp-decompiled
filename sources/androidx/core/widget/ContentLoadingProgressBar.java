...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    /* renamed from: lambda$new$0$androidx-core-widget-ContentLoadingProgressBar */
    public /* synthetic */ void m44lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
        this.mPostedHide = false;
        this.mStartTime = -1L;
        setVisibility(8);
    }

    /* renamed from: lambda$new$1$androidx-core-widget-ContentLoadingProgressBar */
    public /* synthetic */ void m45lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda2
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m44lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m45lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
